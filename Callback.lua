...
data = {
{
{text = '› 𝟏 ‹', data = IdUser..'/help1'}, {text = '𝟐', data = IdUser..'/help2'}, {text = '𝟑', data = IdUser..'/help3'},
},
{
{text = '𝟒', data = IdUser..'/help4'}, {text = '𝟓', data = IdUser..'/help5'}, {text = '𝟔', data = IdUser..'/help6'},
},
{
...
{
{text = '𝟒', data = IdUser..'/help4'},{text = '𝟓', data = IdUser..'/help5'}, {text = '𝟔', data = IdUser..'/helpp6'},
},
{
