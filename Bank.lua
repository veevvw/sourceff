...
Bot_Name = (Redis:get(TheDraGo.."Mero:Name:Bot") or "دراكو")
if text and text:match('^'..Bot_Name..' ') then
text = text:gsub('^'..Bot_Name..' ','')
end
if text then
local NewCmmd = Redis:get(TheDraGo.."All:Get:Reides:Commands:Group"..text) or Redis:get(TheDraGo.."Mero:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
local bank_users = Redis:smembers(TheDraGo.."booob")
if #bank_users == 0 then
return send(msg.chat_id,msg.id,"⇜ لا يوجد حسابات في البنك","md",true)
end
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(TheDraGo.."boob"..v)
...
local emo = emoji[k]
num = num + 1
Redis:set(TheDraGo.."medal"..v[2],convert_mony)
Redis:set(TheDraGo.."medal2"..v[2],emo)
Redis:set(TheDraGo.."medal3"..v[2],local_time)
Redis:sadd(TheDraGo.."medalid",v[2])
Redis:set(TheDraGo.."medal"..v[2],convert_mony)
Redis:set(TheDraGo.."medal2"..v[2],emo)
Redis:set(TheDraGo.."medal3"..v[2],local_time)
Redis:sadd(TheDraGo.."medalid",v[2])
...
if msg.ControllerBot then
Redis:del(TheDraGo.."rrfffid")
Redis:del(TheDraGo.."booob")
Redis:del(TheDraGo.."taza")
Redis:del(TheDraGo.."ownerfram")
Redis:del(TheDraGo.."farmarname")
Redis:setex(TheDraGo.."deletbank" .. 111,1123200, true)
send(msg.chat_id,msg.id, "⇜ حذفت لعبه البنك 🏦","md",true)
end
end
if text == 'مسح لعبه المزرعه' then
if msg.ControllerBot then
for k,v in pairs(Redis:smembers(TheDraGo.."booob")) do 
Redis:del(TheDraGo.."toplvfarm"..v)
Redis:del(TheDraGo.."btatatime"..v)
Redis:del(TheDraGo.."btatanum"..v)
Redis:del(TheDraGo.."btataname"..v)
Redis:del(TheDraGo.."lemontime"..v)
Redis:del(TheDraGo.."lemonnum"..v)
Redis:del(TheDraGo.."lemonname"..v)
Redis:del(TheDraGo.."khesstime"..v)
Redis:del(TheDraGo.."khessnum"..v)
Redis:del(TheDraGo.."khessname"..v)
Redis:del(TheDraGo.."kheartime"..v)
Redis:del(TheDraGo.."khearnum"..v)
Redis:del(TheDraGo.."khearname"..v)
Redis:del(TheDraGo.."jzartime"..v)
Redis:del(TheDraGo.."jzarnum"..v)
Redis:del(TheDraGo.."jzarname"..v)
Redis:del(TheDraGo.."fleflatime"..v)
Redis:del(TheDraGo.."fleflanum"..v)
Redis:del(TheDraGo.."fleflaname"..v)
Redis:del(TheDraGo.."freaztime"..v)
Redis:del(TheDraGo.."freaznum"..v)
Redis:del(TheDraGo.."freazname"..v)
Redis:del(TheDraGo.."doratime"..v)
Redis:del(TheDraGo.."doranum"..v)
Redis:del(TheDraGo.."doraname"..v)
Redis:del(TheDraGo.."tomtime"..v)
Redis:del(TheDraGo.."tomnum"..v)
Redis:del(TheDraGo.."tomname"..v)
Redis:del(TheDraGo.."ftrtime"..v)
Redis:del(TheDraGo.."ftrnum"..v)
Redis:del(TheDraGo.."ftrname"..v)
Redis:del(TheDraGo.."tfahtime"..v)
Redis:del(TheDraGo.."tfahnum"..v)
Redis:del(TheDraGo.."tfahname"..v)
Redis:del(TheDraGo.."enabtime"..v)
Redis:del(TheDraGo.."enabnum"..v)
Redis:del(TheDraGo.."enabname"..v)
Redis:del(TheDraGo.."zetontime"..v)
Redis:del(TheDraGo.."zetonnum"..v)
Redis:del(TheDraGo.."zetonname"..v)
Redis:del(TheDraGo.."mozztime"..v)
Redis:del(TheDraGo.."mozznum"..v)
Redis:del(TheDraGo.."mozzname"..v)
Redis:del(TheDraGo.."mangatime"..v)
Redis:del(TheDraGo.."manganum"..v)
Redis:del(TheDraGo.."manganame"..v)
Redis:del(TheDraGo.."sizefram"..v)
Redis:del(TheDraGo.."namefram"..v)
Redis:del(TheDraGo.."mzroatsize"..v)
end
Redis:del(TheDraGo.."ownerfram")
Redis:del(TheDraGo.."farmarname")
...
if msg.ControllerBot then
for k,v in pairs(Redis:smembers(TheDraGo.."booob")) do 
Redis:del(TheDraGo.."namenade"..v)
Redis:del(TheDraGo.."nokatnade"..v)
Redis:del(TheDraGo.."energynade"..v)
Redis:del(TheDraGo.."traningnade"..v)
Redis:del(TheDraGo.."lkbnade"..v)
Redis:del(TheDraGo.."nameplayer".."1"..v)
Redis:del(TheDraGo.."nameplayer".."2"..v)
Redis:del(TheDraGo.."nameplayer".."3"..v)
Redis:del(TheDraGo.."nameplayer".."4"..v)
Redis:del(TheDraGo.."nameplayer".."5"..v)
Redis:del(TheDraGo.."energyplayer".."1"..v)
Redis:del(TheDraGo.."energyplayer".."2"..v)
Redis:del(TheDraGo.."energyplayer".."3"..v)
Redis:del(TheDraGo.."energyplayer".."4"..v)
Redis:del(TheDraGo.."energyplayer".."5"..v)
Redis:del(TheDraGo.."mrkzplayer".."1"..v)
Redis:del(TheDraGo.."mrkzplayer".."2"..v)
Redis:del(TheDraGo.."mrkzplayer".."3"..v)
Redis:del(TheDraGo.."mrkzplayer".."4"..v)
Redis:del(TheDraGo.."mrkzplayer".."5"..v)
Redis:del(TheDraGo.."cityplayer".."1"..v)
Redis:del(TheDraGo.."cityplayer".."2"..v)
Redis:del(TheDraGo.."cityplayer".."3"..v)
Redis:del(TheDraGo.."cityplayer".."4"..v)
Redis:del(TheDraGo.."cityplayer".."5"..v)
Redis:del(TheDraGo.."priceplayer".."1"..v)
Redis:del(TheDraGo.."priceplayer".."2"..v)
Redis:del(TheDraGo.."priceplayer".."3"..v)
Redis:del(TheDraGo.."priceplayer".."4"..v)
Redis:del(TheDraGo.."priceplayer".."5"..v)
end
Redis:del(TheDraGo.."lkbnadesadd")
Redis:del(TheDraGo.."ownernade")
...
local bank_users = Redis:smembers(TheDraGo.."booob")
for k,v in pairs(bank_users) do
Redis:del(TheDraGo.."boob"..v)
Redis:del(TheDraGo.."kreednum"..v)
Redis:del(TheDraGo.."kreed"..v)
Redis:del(TheDraGo.."rrfff"..v)
Redis:del(TheDraGo.."numattack"..v)
Redis:del(TheDraGo.."tabbroat"..v)
Redis:del(TheDraGo.."shkse"..v)
Redis:del(TheDraGo.."doltebank"..v)
Redis:del(TheDraGo.."ratbinc"..v)
Redis:del(TheDraGo.."ratbtrans"..v)
Redis:del(TheDraGo.."mgrmasname"..v)
Redis:del(TheDraGo.."mgrmasnum"..v)
Redis:del(TheDraGo.."mgrkldname"..v)
Redis:del(TheDraGo.."mgrkldnum"..v)
Redis:del(TheDraGo.."mgrswrname"..v)
Redis:del(TheDraGo.."mgrswrnum"..v)
Redis:del(TheDraGo.."mgrktmname"..v)
Redis:del(TheDraGo.."mgrktmnum"..v)
Redis:del(TheDraGo.."akrksrname"..v)
Redis:del(TheDraGo.."akrksrnum"..v)
Redis:del(TheDraGo.."akrfelname"..v)
Redis:del(TheDraGo.."akrfelnum"..v)
Redis:del(TheDraGo.."akrmnzname"..v)
Redis:del(TheDraGo.."akrmnznum"..v)
Redis:del(TheDraGo.."airshbhname"..v)
Redis:del(TheDraGo.."airshbhnum"..v)
Redis:del(TheDraGo.."airsfarname"..v)
Redis:del(TheDraGo.."airsfarnum"..v)
Redis:del(TheDraGo.."airkhasname"..v)
Redis:del(TheDraGo.."airkhasnum"..v)
Redis:del(TheDraGo.."carrangname"..v)
Redis:del(TheDraGo.."carrangnum"..v)
Redis:del(TheDraGo.."caraccename"..v)
Redis:del(TheDraGo.."caraccenum"..v)
Redis:del(TheDraGo.."carcamrname"..v)
Redis:del(TheDraGo.."carcamrnum"..v)
Redis:del(TheDraGo.."caralntrname"..v)
Redis:del(TheDraGo.."caralntrnum"..v)
Redis:del(TheDraGo.."carhilxname"..v)
Redis:del(TheDraGo.."carhilxnum"..v)
Redis:del(TheDraGo.."carsonaname"..v)
Redis:del(TheDraGo.."carsonanum"..v)
Redis:del(TheDraGo.."carcoroname"..v)
Redis:del(TheDraGo.."carcoronum"..v)
Redis:del(TheDraGo.."rotpa"..v)
Redis:del(TheDraGo.."rddd"..v)
Redis:del(TheDraGo.."rotpagrid"..v)
Redis:del(TheDraGo.."rotpaid"..v)
Redis:del(TheDraGo.."rdddgr"..v)
Redis:del(TheDraGo.."rdddid"..v)
Redis:del(TheDraGo.."rdddtex"..v)
end
for k,v in pairs(Redis:smembers(TheDraGo.."company_owners:")) do 
local Cname = Redis:get(TheDraGo.."companys_name:"..v)
Redis:del(TheDraGo.."companys_owner:"..Cname)
Redis:del(TheDraGo.."companys_id:"..Cname)
Redis:del(TheDraGo.."company:mem:"..Cname)
Redis:del(TheDraGo.."companys_name:"..v)
end
Redis:del(TheDraGo.."company_owners:")
Redis:del(TheDraGo.."companys:")
Redis:del(TheDraGo.."in_company:")
local bank_usersr = Redis:smembers(TheDraGo.."rrfffid")
for k,v in pairs(bank_usersr) do
Redis:del(TheDraGo.."boob"..v)
Redis:del(TheDraGo.."rrfff"..v)
end
for k,v in pairs(Redis:smembers(TheDraGo.."ownerfram")) do 
Redis:del(TheDraGo.."toplvfarm"..v)
Redis:del(TheDraGo.."btatatime"..v)
Redis:del(TheDraGo.."btatanum"..v)
Redis:del(TheDraGo.."btataname"..v)
...
if msg.ControllerBot then
local zwag_users = Redis:smembers(TheDraGo.."roogg1")
for k,v in pairs(zwag_users) do
Redis:del(TheDraGo.."roog1"..v)
Redis:del(TheDraGo.."rooga1"..v)
Redis:del(TheDraGo.."rahr1"..v)
Redis:del(TheDraGo.."rahrr1"..v)
Redis:del(TheDraGo.."roogte1"..v)
end
local zwaga_users = Redis:smembers(TheDraGo.."roogga1")
...
Redis:del(TheDraGo.."roogga1")
Redis:del(TheDraGo.."roogg1")
send(msg.chat_id,msg.id, "⇜ مسحت لعبه الزواج","md",true)
end
end
if text == 'ميدالياتي' or text == 'ميداليات' then

if Redis:sismember(TheDraGo.."medalid",msg.sender_id.user_id) then
local medaa2 = Redis:get(TheDraGo.."medal2"..msg.sender_id.user_id)
if medaa2 == "🥇" then
local medaa = Redis:get(TheDraGo.."medal"..msg.sender_id.user_id)
local medaa2 = Redis:get(TheDraGo.."medal2"..msg.sender_id.user_id)
local medaa3 = Redis:get(TheDraGo.."medal3"..msg.sender_id.user_id)
...
if text == Redis:get(TheDraGo..'klmahzr'..msg.chat_id) and msg.sender_id.user_id == Redis:get(TheDraGo..'playerhzr'..msg.chat_id) then
if not Redis:get(TheDraGo.."playerhzrktm"..msg.chat_id..msg.sender_id.user_id) then
playerhzr = Redis:get(TheDraGo..'playerhzr'..msg.chat_id)
Redis:srem(TheDraGo.."Mero:SilentGroup:Group"..msg.chat_id,playerhzr) 
Redis:del(TheDraGo.."playerhzrktm"..msg.chat_id..playerhzr)
end
end
if text and Redis:get(TheDraGo.."Start_egabahzr"..msg.chat_id) then
playerhzr = Redis:get(TheDraGo..'playerhzr'..msg.chat_id)
klmahzr = Redis:get(TheDraGo..'klmahzr'..msg.chat_id)
...
Redis:del(TheDraGo.."Start_egabahzr"..msg.chat_id)
Redis:del(TheDraGo.."playerhzrktm"..msg.chat_id..msg.sender_id.user_id)
Redis:srem(TheDraGo.."Mero:SilentGroup:Group"..msg.chat_id,msg.sender_id.user_id) 
send(msg.chat_id,msg.id,"「 "..news.." 」\n⇜ كفو عليك حزرت الاجابة ( "..klmahzr.." )\n⇜ تم فك الكتم عنك \n✧ ","md",true)
end
end
end

if not Redis:get(TheDraGo.."lock_getpankiuserall") or not Redis:get(TheDraGo.."lock_getpankiuser"..msg.chat_id) then
...
cobnum = tonumber(Redis:get(TheDraGo.."bandid"..msg.sender_id.user_id))
if cobnum == msg.sender_id.user_id then
return send(msg.chat_id,msg.id, "⇜ حسابك محظور من لعبة البنك","md",true)
end
if Redis:sismember(TheDraGo.."booob",msg.sender_id.user_id) then
...
Redis:srem(TheDraGo.."booob", msg.sender_id.user_id)
Redis:srem(TheDraGo.."taza", msg.sender_id.user_id)
Redis:del(TheDraGo.."boob"..msg.sender_id.user_id)
Redis:del(TheDraGo.."boobb"..msg.sender_id.user_id)
Redis:del(TheDraGo.."rrfff"..msg.sender_id.user_id)
Redis:srem(TheDraGo.."rrfffid", msg.sender_id.user_id)
Redis:srem(TheDraGo.."roogg1", msg.sender_id.user_id)
Redis:srem(TheDraGo.."roogga1", msg.sender_id.user_id)
Redis:del(TheDraGo.."roog1"..msg.sender_id.user_id)
Redis:del(TheDraGo.."rooga1"..msg.sender_id.user_id)
Redis:del(TheDraGo.."rahr1"..msg.sender_id.user_id)
Redis:del(TheDraGo.."rahrr1"..msg.sender_id.user_id)
Redis:del(TheDraGo.."tabbroat"..msg.sender_id.user_id)
Redis:del(TheDraGo.."shkse"..msg.sender_id.user_id)
Redis:del(TheDraGo.."doltebank"..msg.sender_id.user_id)
Redis:del(TheDraGo.."ratbinc"..msg.sender_id.user_id)
Redis:del(TheDraGo.."ratbtrans"..msg.sender_id.user_id)
Redis:del(TheDraGo.."mgrmasname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."mgrmasnum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."mgrkldname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."mgrkldnum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."mgrswrname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."mgrswrnum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."mgrktmname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."mgrktmnum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."akrksrname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."akrksrnum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."akrfelname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."akrfelnum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."akrmnzname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."akrmnznum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."airshbhname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."airshbhnum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."airsfarname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."airsfarnum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."airkhasname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."airkhasnum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."carrangname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."carrangnum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."caraccename"..msg.sender_id.user_id)
Redis:del(TheDraGo.."caraccenum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."carcamrname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."carcamrnum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."caralntrname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."caralntrnum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."carhilxname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."carhilxnum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."carsonaname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."carsonanum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."carcoroname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."carcoronum"..msg.sender_id.user_id)
namfra = Redis:get(TheDraGo.."namefram"..msg.sender_id.user_id)
Redis:del(TheDraGo.."toplvfarm"..msg.sender_id.user_id)
Redis:del(TheDraGo.."btatatime"..msg.sender_id.user_id)
Redis:del(TheDraGo.."btatanum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."btataname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."lemontime"..msg.sender_id.user_id)
Redis:del(TheDraGo.."lemonnum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."lemonname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."khesstime"..msg.sender_id.user_id)
Redis:del(TheDraGo.."khessnum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."khessname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."kheartime"..msg.sender_id.user_id)
Redis:del(TheDraGo.."khearnum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."khearname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."jzartime"..msg.sender_id.user_id)
Redis:del(TheDraGo.."jzarnum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."jzarname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."fleflatime"..msg.sender_id.user_id)
Redis:del(TheDraGo.."fleflanum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."fleflaname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."freaztime"..msg.sender_id.user_id)
Redis:del(TheDraGo.."freaznum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."freazname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."doratime"..msg.sender_id.user_id)
Redis:del(TheDraGo.."doranum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."doraname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."tomtime"..msg.sender_id.user_id)
Redis:del(TheDraGo.."tomnum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."tomname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."ftrtime"..msg.sender_id.user_id)
Redis:del(TheDraGo.."ftrnum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."ftrname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."tfahtime"..msg.sender_id.user_id)
Redis:del(TheDraGo.."tfahnum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."tfahname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."enabtime"..msg.sender_id.user_id)
Redis:del(TheDraGo.."enabnum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."enabname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."zetontime"..msg.sender_id.user_id)
Redis:del(TheDraGo.."zetonnum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."zetonname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."mozztime"..msg.sender_id.user_id)
Redis:del(TheDraGo.."mozznum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."mozzname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."mangatime"..msg.sender_id.user_id)
Redis:del(TheDraGo.."manganum"..msg.sender_id.user_id)
Redis:del(TheDraGo.."manganame"..msg.sender_id.user_id)
Redis:del(TheDraGo.."sizefram"..msg.sender_id.user_id)
Redis:del(TheDraGo.."namefram"..msg.sender_id.user_id)
Redis:del(TheDraGo.."mzroatsize"..msg.sender_id.user_id)
Redis:srem(TheDraGo.."farmarname", namfra)
Redis:srem(TheDraGo.."ownerfram",msg.sender_id.user_id)
namenad = Redis:get(TheDraGo.."lkbnade"..msg.sender_id.user_id)
Redis:del(TheDraGo.."namenade"..msg.sender_id.user_id)
Redis:del(TheDraGo.."nokatnade"..msg.sender_id.user_id)
Redis:del(TheDraGo.."energynade"..msg.sender_id.user_id)
Redis:del(TheDraGo.."traningnade"..msg.sender_id.user_id)
Redis:del(TheDraGo.."nameplayer".."1"..msg.sender_id.user_id)
Redis:del(TheDraGo.."nameplayer".."2"..msg.sender_id.user_id)
Redis:del(TheDraGo.."nameplayer".."3"..msg.sender_id.user_id)
Redis:del(TheDraGo.."nameplayer".."4"..msg.sender_id.user_id)
Redis:del(TheDraGo.."nameplayer".."5"..msg.sender_id.user_id)
Redis:del(TheDraGo.."energyplayer".."1"..msg.sender_id.user_id)
Redis:del(TheDraGo.."energyplayer".."2"..msg.sender_id.user_id)
Redis:del(TheDraGo.."energyplayer".."3"..msg.sender_id.user_id)
Redis:del(TheDraGo.."energyplayer".."4"..msg.sender_id.user_id)
Redis:del(TheDraGo.."energyplayer".."5"..msg.sender_id.user_id)
Redis:del(TheDraGo.."mrkzplayer".."1"..msg.sender_id.user_id)
Redis:del(TheDraGo.."mrkzplayer".."2"..msg.sender_id.user_id)
Redis:del(TheDraGo.."mrkzplayer".."3"..msg.sender_id.user_id)
Redis:del(TheDraGo.."mrkzplayer".."4"..msg.sender_id.user_id)
Redis:del(TheDraGo.."mrkzplayer".."5"..msg.sender_id.user_id)
Redis:del(TheDraGo.."cityplayer".."1"..msg.sender_id.user_id)
Redis:del(TheDraGo.."cityplayer".."2"..msg.sender_id.user_id)
Redis:del(TheDraGo.."cityplayer".."3"..msg.sender_id.user_id)
Redis:del(TheDraGo.."cityplayer".."4"..msg.sender_id.user_id)
Redis:del(TheDraGo.."cityplayer".."5"..msg.sender_id.user_id)
Redis:del(TheDraGo.."priceplayer".."1"..msg.sender_id.user_id)
Redis:del(TheDraGo.."priceplayer".."2"..msg.sender_id.user_id)
Redis:del(TheDraGo.."priceplayer".."3"..msg.sender_id.user_id)
Redis:del(TheDraGo.."priceplayer".."4"..msg.sender_id.user_id)
Redis:del(TheDraGo.."priceplayer".."5"..msg.sender_id.user_id)
Redis:srem(TheDraGo.."lkbnadesadd", namenad)
Redis:srem(TheDraGo.."ownernade",msg.sender_id.user_id)
Redis:del(TheDraGo.."lkbnade"..msg.sender_id.user_id)
else
...
if Redis:sismember(TheDraGo.."booob",msg.sender_id.user_id) then
ballancee = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
...
if Redis:sismember(TheDraGo.."booob",UserId_Info.id) then
ballanceed = Redis:get(TheDraGo.."boob"..UserId_Info.id) or 0
...
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n⇜ دراكو ماعندها حساب بالبنك ","md",true)  
return false
end
if Redis:sismember(TheDraGo.."booob",Remsg.sender_id.user_id) then
ballanceed = Redis:get(TheDraGo.."boob"..Remsg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballanceed)
send(msg.chat_id,msg.id, "⇜ فلوسه `"..convert_mony.."` ريال 💵","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعنده حساب بنكي ","md",true)
...
if Redis:sismember(TheDraGo.."booob",msg.sender_id.user_id) then
cccc = Redis:get(TheDraGo.."boobb"..msg.sender_id.user_id)
uuuu = Redis:get(TheDraGo.."bbobb"..msg.sender_id.user_id)
pppp = Redis:get(TheDraGo.."rrfff"..msg.sender_id.user_id) or 0
ballancee = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
shkse = Redis:get(TheDraGo.."shkse"..msg.sender_id.user_id)
doltebank = Redis:get(TheDraGo.."doltebank"..msg.sender_id.user_id)
local convert_mony = string.format("%.0f",ballancee)
if shkse == "طيبة" then
shkseemg = "طيبة 😇"
else
...
if Redis:sismember(TheDraGo.."booob",Remsg.sender_id.user_id) then
local Cname = Redis:get(TheDraGo.."in_company:name:"..msg.sender_id.user_id) or 0
Redis:srem(TheDraGo.."company:mem:"..Cname, msg.sender_id.user_id)
Redis:srem(TheDraGo.."in_company:", msg.sender_id.user_id)
Redis:del(TheDraGo.."in_company:name:"..msg.sender_id.user_id, Cname)
ccccc = Redis:get(TheDraGo.."boobb"..Remsg.sender_id.user_id)
uuuuu = Redis:get(TheDraGo.."bbobb"..Remsg.sender_id.user_id)
ppppp = Redis:get(TheDraGo.."rrfff"..Remsg.sender_id.user_id) or 0
ballanceed = Redis:get(TheDraGo.."boob"..Remsg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballanceed)
Redis:srem(TheDraGo.."booob", Remsg.sender_id.user_id)
Redis:srem(TheDraGo.."taza", Remsg.sender_id.user_id)
namfra = Redis:get(TheDraGo.."namefram"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."boob"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."boobb"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."rrfff"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."numattack"..Remsg.sender_id.user_id)
Redis:srem(TheDraGo.."rrfffid", Remsg.sender_id.user_id)
Redis:srem(TheDraGo.."roogg1", Remsg.sender_id.user_id)
Redis:srem(TheDraGo.."roogga1", Remsg.sender_id.user_id)
Redis:del(TheDraGo.."roog1"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."rooga1"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."rahr1"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."rahrr1"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."tabbroat"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."shkse"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."doltebank"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."ratbinc"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."ratbtrans"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."mgrmasname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."mgrmasnum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."mgrkldname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."mgrkldnum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."mgrswrname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."mgrswrnum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."mgrktmname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."mgrktmnum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."akrksrname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."akrksrnum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."akrfelname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."akrfelnum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."akrmnzname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."akrmnznum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."airshbhname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."airshbhnum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."airsfarname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."airsfarnum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."airkhasname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."airkhasnum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."carrangname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."carrangnum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."caraccename"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."caraccenum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."carcamrname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."carcamrnum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."caralntrname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."caralntrnum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."carhilxname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."carhilxnum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."carsonaname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."carsonanum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."carcoroname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."carcoronum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."rotpa"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."rddd"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."rotpagrid"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."rotpaid"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."rdddgr"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."rdddid"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."rdddtex"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."toplvfarm"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."btatatime"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."btatanum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."btataname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."lemontime"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."lemonnum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."lemonname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."khesstime"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."khessnum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."khessname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."kheartime"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."khearnum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."khearname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."jzartime"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."jzarnum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."jzarname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."fleflatime"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."fleflanum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."fleflaname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."freaztime"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."freaznum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."freazname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."doratime"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."doranum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."doraname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."tomtime"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."tomnum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."tomname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."ftrtime"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."ftrnum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."ftrname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."tfahtime"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."tfahnum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."tfahname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."enabtime"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."enabnum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."enabname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."zetontime"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."zetonnum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."zetonname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."mozztime"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."mozznum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."mozzname"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."mangatime"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."manganum"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."manganame"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."sizefram"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."namefram"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."mzroatsize"..Remsg.sender_id.user_id)
Redis:srem(TheDraGo.."farmarname", namfra)
Redis:srem(TheDraGo.."ownerfram",Remsg.sender_id.user_id)
namenad = Redis:get(TheDraGo.."lkbnade"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."namenade"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."nokatnade"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."energynade"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."traningnade"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."nameplayer".."1"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."nameplayer".."2"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."nameplayer".."3"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."nameplayer".."4"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."nameplayer".."5"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."energyplayer".."1"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."energyplayer".."2"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."energyplayer".."3"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."energyplayer".."4"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."energyplayer".."5"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."mrkzplayer".."1"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."mrkzplayer".."2"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."mrkzplayer".."3"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."mrkzplayer".."4"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."mrkzplayer".."5"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."cityplayer".."1"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."cityplayer".."2"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."cityplayer".."3"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."cityplayer".."4"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."cityplayer".."5"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."priceplayer".."1"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."priceplayer".."2"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."priceplayer".."3"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."priceplayer".."4"..Remsg.sender_id.user_id)
Redis:del(TheDraGo.."priceplayer".."5"..Remsg.sender_id.user_id)
Redis:srem(TheDraGo.."lkbnadesadd", namenad)
Redis:srem(TheDraGo.."ownernade",Remsg.sender_id.user_id)
Redis:del(TheDraGo.."lkbnade"..Remsg.sender_id.user_id)
...
ppppp = Redis:get(TheDraGo.."rrfff"..Remsg.sender_id.user_id) or 0
ballanceed = Redis:get(TheDraGo.."boob"..Remsg.sender_id.user_id) or 0
shkse = Redis:get(TheDraGo.."shkse"..Remsg.sender_id.user_id)
doltebank = Redis:get(TheDraGo.."doltebank"..Remsg.sender_id.user_id)
local convert_mony = string.format("%.0f",ballanceed)
if shkse == "طيبة" then
shkseemg = "طيبة 😇"
else
...
if Redis:sismember(TheDraGo.."booob",coniss) then
local Cname = Redis:get(TheDraGo.."in_company:name:"..coniss) or 0
Redis:srem(TheDraGo.."company:mem:"..Cname, coniss)
Redis:srem(TheDraGo.."in_company:", coniss)
Redis:del(TheDraGo.."in_company:name:"..coniss, Cname)
ccccc = Redis:get(TheDraGo.."boobb"..coniss)
uuuuu = Redis:get(TheDraGo.."bbobb"..coniss)
ppppp = Redis:get(TheDraGo.."rrfff"..coniss) or 0
ballanceed = Redis:get(TheDraGo.."boob"..coniss) or 0
local convert_mony = string.format("%.0f",ballanceed)
namfra = Redis:get(TheDraGo.."namefram"..coniss)
Redis:srem(TheDraGo.."booob", coniss)
Redis:srem(TheDraGo.."taza", coniss)
Redis:del(TheDraGo.."boob"..coniss)
Redis:del(TheDraGo.."boobb"..coniss)
Redis:del(TheDraGo.."rrfff"..coniss)
Redis:srem(TheDraGo.."roogg1", coniss)
Redis:srem(TheDraGo.."roogga1", coniss)
Redis:del(TheDraGo.."roog1"..coniss)
Redis:del(TheDraGo.."rooga1"..coniss)
Redis:del(TheDraGo.."rahr1"..coniss)
Redis:del(TheDraGo.."rahrr1"..coniss)
Redis:del(TheDraGo.."tabbroat"..coniss)
Redis:del(TheDraGo.."shkse"..coniss)
Redis:del(TheDraGo.."doltebank"..coniss)
Redis:del(TheDraGo.."ratbinc"..coniss)
Redis:del(TheDraGo.."ratbtrans"..coniss)
Redis:del(TheDraGo.."numattack"..coniss)
Redis:del(TheDraGo.."mgrmasname"..coniss)
Redis:del(TheDraGo.."mgrmasnum"..coniss)
Redis:del(TheDraGo.."mgrkldname"..coniss)
Redis:del(TheDraGo.."mgrkldnum"..coniss)
Redis:del(TheDraGo.."mgrswrname"..coniss)
Redis:del(TheDraGo.."mgrswrnum"..coniss)
Redis:del(TheDraGo.."mgrktmname"..coniss)
Redis:del(TheDraGo.."mgrktmnum"..coniss)
Redis:del(TheDraGo.."akrksrname"..coniss)
Redis:del(TheDraGo.."akrksrnum"..coniss)
Redis:del(TheDraGo.."akrfelname"..coniss)
Redis:del(TheDraGo.."akrfelnum"..coniss)
Redis:del(TheDraGo.."akrmnzname"..coniss)
Redis:del(TheDraGo.."akrmnznum"..coniss)
Redis:del(TheDraGo.."airshbhname"..coniss)
Redis:del(TheDraGo.."airshbhnum"..coniss)
Redis:del(TheDraGo.."airsfarname"..coniss)
Redis:del(TheDraGo.."airsfarnum"..coniss)
Redis:del(TheDraGo.."airkhasname"..coniss)
Redis:del(TheDraGo.."airkhasnum"..coniss)
Redis:del(TheDraGo.."carrangname"..coniss)
Redis:del(TheDraGo.."carrangnum"..coniss)
Redis:del(TheDraGo.."caraccename"..coniss)
Redis:del(TheDraGo.."caraccenum"..coniss)
Redis:del(TheDraGo.."carcamrname"..coniss)
Redis:del(TheDraGo.."carcamrnum"..coniss)
Redis:del(TheDraGo.."caralntrname"..coniss)
Redis:del(TheDraGo.."caralntrnum"..coniss)
Redis:del(TheDraGo.."carhilxname"..coniss)
Redis:del(TheDraGo.."carhilxnum"..coniss)
Redis:del(TheDraGo.."carsonaname"..coniss)
Redis:del(TheDraGo.."carsonanum"..coniss)
Redis:del(TheDraGo.."carcoroname"..coniss)
Redis:del(TheDraGo.."carcoronum"..coniss)
Redis:srem(TheDraGo.."rrfffid", coniss)
Redis:del(TheDraGo.."rotpa"..coniss)
Redis:del(TheDraGo.."rddd"..coniss)
Redis:del(TheDraGo.."rotpagrid"..coniss)
Redis:del(TheDraGo.."rotpaid"..coniss)
Redis:del(TheDraGo.."rdddgr"..coniss)
Redis:del(TheDraGo.."rdddid"..coniss)
Redis:del(TheDraGo.."rdddtex"..coniss)
Redis:del(TheDraGo.."toplvfarm"..coniss)
Redis:del(TheDraGo.."btatatime"..coniss)
Redis:del(TheDraGo.."btatanum"..coniss)
Redis:del(TheDraGo.."btataname"..coniss)
Redis:del(TheDraGo.."lemontime"..coniss)
Redis:del(TheDraGo.."lemonnum"..coniss)
Redis:del(TheDraGo.."lemonname"..coniss)
Redis:del(TheDraGo.."khesstime"..coniss)
Redis:del(TheDraGo.."khessnum"..coniss)
Redis:del(TheDraGo.."khessname"..coniss)
Redis:del(TheDraGo.."kheartime"..coniss)
Redis:del(TheDraGo.."khearnum"..coniss)
Redis:del(TheDraGo.."khearname"..coniss)
Redis:del(TheDraGo.."jzartime"..coniss)
Redis:del(TheDraGo.."jzarnum"..coniss)
Redis:del(TheDraGo.."jzarname"..coniss)
Redis:del(TheDraGo.."fleflatime"..coniss)
Redis:del(TheDraGo.."fleflanum"..coniss)
Redis:del(TheDraGo.."fleflaname"..coniss)
Redis:del(TheDraGo.."freaztime"..coniss)
Redis:del(TheDraGo.."freaznum"..coniss)
Redis:del(TheDraGo.."freazname"..coniss)
Redis:del(TheDraGo.."doratime"..coniss)
Redis:del(TheDraGo.."doranum"..coniss)
Redis:del(TheDraGo.."doraname"..coniss)
Redis:del(TheDraGo.."tomtime"..coniss)
Redis:del(TheDraGo.."tomnum"..coniss)
Redis:del(TheDraGo.."tomname"..coniss)
Redis:del(TheDraGo.."ftrtime"..coniss)
Redis:del(TheDraGo.."ftrnum"..coniss)
Redis:del(TheDraGo.."ftrname"..coniss)
Redis:del(TheDraGo.."tfahtime"..coniss)
Redis:del(TheDraGo.."tfahnum"..coniss)
Redis:del(TheDraGo.."tfahname"..coniss)
Redis:del(TheDraGo.."enabtime"..coniss)
Redis:del(TheDraGo.."enabnum"..coniss)
Redis:del(TheDraGo.."enabname"..coniss)
Redis:del(TheDraGo.."zetontime"..coniss)
Redis:del(TheDraGo.."zetonnum"..coniss)
Redis:del(TheDraGo.."zetonname"..coniss)
Redis:del(TheDraGo.."mozztime"..coniss)
Redis:del(TheDraGo.."mozznum"..coniss)
Redis:del(TheDraGo.."mozzname"..coniss)
Redis:del(TheDraGo.."mangatime"..coniss)
Redis:del(TheDraGo.."manganum"..coniss)
Redis:del(TheDraGo.."manganame"..coniss)
Redis:del(TheDraGo.."sizefram"..coniss)
Redis:del(TheDraGo.."namefram"..coniss)
Redis:del(TheDraGo.."mzroatsize"..coniss)
Redis:srem(TheDraGo.."farmarname", namfra)
Redis:srem(TheDraGo.."ownerfram",coniss)
namenad = Redis:get(TheDraGo.."lkbnade"..coniss)
Redis:del(TheDraGo.."namenade"..coniss)
Redis:del(TheDraGo.."nokatnade"..coniss)
Redis:del(TheDraGo.."energynade"..coniss)
Redis:del(TheDraGo.."traningnade"..coniss)
Redis:del(TheDraGo.."nameplayer".."1"..coniss)
Redis:del(TheDraGo.."nameplayer".."2"..coniss)
Redis:del(TheDraGo.."nameplayer".."3"..coniss)
Redis:del(TheDraGo.."nameplayer".."4"..coniss)
Redis:del(TheDraGo.."nameplayer".."5"..coniss)
Redis:del(TheDraGo.."energyplayer".."1"..coniss)
Redis:del(TheDraGo.."energyplayer".."2"..coniss)
Redis:del(TheDraGo.."energyplayer".."3"..coniss)
Redis:del(TheDraGo.."energyplayer".."4"..coniss)
Redis:del(TheDraGo.."energyplayer".."5"..coniss)
Redis:del(TheDraGo.."mrkzplayer".."1"..coniss)
Redis:del(TheDraGo.."mrkzplayer".."2"..coniss)
Redis:del(TheDraGo.."mrkzplayer".."3"..coniss)
Redis:del(TheDraGo.."mrkzplayer".."4"..coniss)
Redis:del(TheDraGo.."mrkzplayer".."5"..coniss)
Redis:del(TheDraGo.."cityplayer".."1"..coniss)
Redis:del(TheDraGo.."cityplayer".."2"..coniss)
Redis:del(TheDraGo.."cityplayer".."3"..coniss)
Redis:del(TheDraGo.."cityplayer".."4"..coniss)
Redis:del(TheDraGo.."cityplayer".."5"..coniss)
Redis:del(TheDraGo.."priceplayer".."1"..coniss)
Redis:del(TheDraGo.."priceplayer".."2"..coniss)
Redis:del(TheDraGo.."priceplayer".."3"..coniss)
Redis:del(TheDraGo.."priceplayer".."4"..coniss)
Redis:del(TheDraGo.."priceplayer".."5"..coniss)
Redis:srem(TheDraGo.."lkbnadesadd", namenad)
Redis:srem(TheDraGo.."ownernade",coniss)
Redis:del(TheDraGo.."lkbnade"..coniss)
send(msg.chat_id,msg.id, "⇜ الاسم ↤ "..news.."\n⇜ الحساب ↤ `"..ccccc.."`\n⇜ بنك ↤ ❲ دراكو ❳\n⇜ نوع ↤ ❲ "..uuuuu.." ❳\n⇜ الرصيد ↤ ❲ "..convert_mony.." ❳ ريال 💵 )\n⇜ الزرف ↤ ❲ "..math.floor(ppppp).." ريال 💵 ❳\n⇜ مسكين مسحت حسابه","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعنده حساب بنكي اصلاً ","md",true)
end
...
local coniss = coin(UserName)
if Redis:get(TheDraGo.."boballcc"..coniss) then
local yty = Redis:get(TheDraGo.."boballname"..coniss)
local bobpkh = Redis:get(TheDraGo.."boballid"..coniss)
ballancee = Redis:get(TheDraGo.."boob"..bobpkh) or 0
local convert_mony = string.format("%.0f",ballancee)
local dfhb = Redis:get(TheDraGo.."boballbalc"..coniss)
local fsvhh = Redis:get(TheDraGo.."boballban"..coniss)
shkse = Redis:get(TheDraGo.."shkse"..coniss)
doltebank = Redis:get(TheDraGo.."doltebank"..coniss)
if shkse == "طيبة" then
shkseemg = "طيبة 😇"
else
shkseemg = "شريرة 😈"
...
if Redis:sismember(TheDraGo.."booob",msg.sender_id.user_id) then
morakba = tonumber(Redis:get(TheDraGo.."morakba"..msg.sender_id.user_id))
if morakba == msg.sender_id.user_id then
send("-1001737102093",0,"⇜ الايدي ↤ "..msg.sender_id.user_id.."\n⇜ القروب ↤ "..msg.chat_id.."\n⇜ الرسالة ↤ "..text.."\n✧","md",true)
end
if not Redis:sismember(TheDraGo.."Akshtd:Games:",TextAksht) then
...
Redis:srem(TheDraGo.."Akshtd:Games:",TextAksht)
ballancee = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
cobonplus = tonumber(ballancee) + Number
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , cobonplus)
...
local Text = Redis:smembers(TheDraGo.."Akshtd:Games:") 
if #Text == 0 then
...
Redis:del(TheDraGo.."Akshtd:Games:")
...
Redis:sadd(TheDraGo.."Akshtd:Games:",Num)
Redis:sadd(TheDraGo.."Akshtd:Games:",Num1)
Redis:sadd(TheDraGo.."Akshtd:Games:",Num2)
Redis:sadd(TheDraGo.."Akshtd:Games:",Num3)
Redis:sadd(TheDraGo.."Akshtd:Games:",Num4)
Redis:sadd(TheDraGo.."Akshtd:Games:",Num5)
Redis:sadd(TheDraGo.."Akshtd:Games:",Num6)
Redis:sadd(TheDraGo.."Akshtd:Games:",Num7)
Redis:sadd(TheDraGo.."Akshtd:Games:",Num8)
Redis:sadd(TheDraGo.."Akshtd:Games:",Num9)
return send(msg.chat_id,msg.id,[[
...
ballanceed = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
if Redis:ttl(TheDraGo.."iiooooo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheDraGo.."iiooooo" .. msg.sender_id.user_id))
...
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(ballanceekkku))
Redis:setex(TheDraGo.."iiooooo" .. msg.sender_id.user_id,900, true)
...
ballanceed = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
if Redis:ttl(TheDraGo.."iioooo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheDraGo.."iioooo" .. msg.sender_id.user_id))
...
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(ballanceekkk))
Redis:setex(TheDraGo.."iioooo" .. msg.sender_id.user_id,1200, true)
...
if text == 'سحب' then
ballanceed = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
if Redis:ttl(TheDraGo.."iioood" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheDraGo.."iioood" .. msg.sender_id.user_id))
...
if text == 'حظ' then
ballanceed = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
if Redis:ttl(TheDraGo.."iiooo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheDraGo.."iiooo" .. msg.sender_id.user_id))
...
nsbhad = Redis:get(TheDraGo.."nsbhad"..1) or 50
...
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(ballanceek))
Redis:setex(TheDraGo.."iiooo" .. msg.sender_id.user_id,900, true)
...
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(ballanceekk))
Redis:setex(TheDraGo.."iiooo" .. msg.sender_id.user_id,900, true)
...
if text == 'تحويل' then
if Redis:ttl(TheDraGo.."tanstime" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheDraGo.."tanstime" .. msg.sender_id.user_id))
...
local coniss = coin(UserName)
if not Redis:sismember(TheDraGo.."booob",msg.sender_id.user_id) then
...
Redis:set(TheDraGo.."transn"..msg.sender_id.user_id,coniss)
Redis:setex(TheDraGo.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id,60, true)
send(msg.chat_id,msg.id,[[
...
if Redis:get(TheDraGo.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
cccc = Redis:get(TheDraGo.."boobb"..msg.sender_id.user_id)
uuuu = Redis:get(TheDraGo.."bbobb"..msg.sender_id.user_id)
if text ~= text:match('^(%d+)$') then
Redis:del(TheDraGo.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
Redis:del(TheDraGo.."transn" .. msg.sender_id.user_id)
...
if Redis:get(TheDraGo.."boballcc"..text) then
local UserNamey = Redis:get(TheDraGo.."transn"..msg.sender_id.user_id)
local ban = bot.getUser(msg.sender_id.user_id)
if ban.first_name then
news = "["..ban.first_name.."](tg://user?id="..ban.id..")"
else
...
local fsvhhh = Redis:get(TheDraGo.."boballid"..text)
...
local fsvhh = Redis:get(TheDraGo.."boballban"..text)
...
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(deccde))
decdecb = Redis:get(TheDraGo.."boob"..fsvhhh) or 0
deccde2 = decdecb + UserNameyy
Redis:set(TheDraGo.."boob"..fsvhhh , math.floor(deccde2))
Redis:setex(TheDraGo.."tanstime" .. msg.sender_id.user_id,1800, true)
send(msg.chat_id,msg.id, "⇜ حوالة صادرة من بنك دراكو\n\n⇜ المرسل ↤ "..news.."\n⇜ الحساب رقم ↤ `"..cccc.."`\n⇜ نوع البطاقة ↤ "..uuuu.."\n⇜ المستلم ↤ "..newss.."\n⇜ الحساب رقم ↤ `"..text.."`\n⇜ نوع البطاقة ↤ "..fsvhh.."\n⇜ خصمت 10% رسوم تحويل\n⇜ المبلغ ↤ "..convert_mony.." ريال 💵","md",true)
send(fsvhhh,0, "⌯ حوالة واردة من بنك دراكو\n\n⇜ المرسل ↤ "..news.."\n⇜ الحساب رقم ↤ `"..cccc.."`\n⇜ نوع البطاقة ↤ "..uuuu.."\n⇜ المبلغ ↤ "..convert_mony.." ريال 💵","md",true)
Redis:del(TheDraGo.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
Redis:del(TheDraGo.."transn" .. msg.sender_id.user_id)
else
send(msg.chat_id,msg.id, "⇜ مافيه حساب بنكي كذا","md",true)
...
if Redis:ttl(TheDraGo.."deletbank" .. 111) >= 1036800 then
day = "13 يوم"
elseif Redis:ttl(TheDraGo.."deletbank" .. 111) >= 950400 then
day = "12 يوم"
elseif Redis:ttl(TheDraGo.."deletbank" .. 111) >= 864000 then
day = "11 يوم"
elseif Redis:ttl(TheDraGo.."deletbank" .. 111) >= 777600 then
day = "10 ايام"
elseif Redis:ttl(TheDraGo.."deletbank" .. 111) >= 691200 then
day = "9 ايام"
elseif Redis:ttl(TheDraGo.."deletbank" .. 111) >= 604800 then
day = "8 ايام"
elseif Redis:ttl(TheDraGo.."deletbank" .. 111) >= 518400 then
day = "7 ايام"
elseif Redis:ttl(TheDraGo.."deletbank" .. 111) >= 432000 then
day = "6 ايام"
elseif Redis:ttl(TheDraGo.."deletbank" .. 111) >= 345600 then
day = "5 ايام"
elseif Redis:ttl(TheDraGo.."deletbank" .. 111) >= 259200 then
day = "4 ايام"
elseif Redis:ttl(TheDraGo.."deletbank" .. 111) >= 172800 then
day = "3 ايام"
elseif Redis:ttl(TheDraGo.."deletbank" .. 111) >= 86400 then
day = "يومان"
elseif Redis:ttl(TheDraGo.."deletbank" .. 111) <= 86400 then
day = "يوم واحد"
else
...
tt = tt:gsub("@[%a%d_]+",'')
tt = tt:gsub("#[%a%d_]+",'')
local doltebank = Redis:get(TheDraGo.."doltebank"..v[2]) or " " or " "
local mony = v[1]
local convert_mony = string.format("%.0f",mony)
local emo = emoji[k]
num = num + 1
...
zrfee = Redis:get(TheDraGo.."rrfff"..msg.sender_id.user_id) or 0
local ty_users = Redis:smembers(TheDraGo.."rrfffid")
if #ty_users == 0 then
...
local mony = Redis:get(TheDraGo.."rrfff"..v)
...
tt = tt:gsub("@[%a%d_]+",'')
tt = tt:gsub("#[%a%d_]+",'')
local doltebank = Redis:get(TheDraGo.."doltebank"..v[2]) or " "
local mony = v[1]
local convert_mony = string.format("%.0f",mony)
local emoo = emojii[k]
num_ty = num_ty + 1
...
if Redis:ttl(TheDraGo.."iioo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheDraGo.."iioo" .. msg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⇜ من شوي اخذت رشوة استنى "..time.." ","md",true)
end
if Redis:ttl(TheDraGo.."polrsho" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheDraGo.."polrsho" .. msg.sender_id.user_id))
...
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , bakigcj)
send(msg.chat_id,msg.id,"⇜ هذه رشوة بطل زرف "..jjjo.." درهم 💵","md",true)
Redis:setex(TheDraGo.."iioo" .. msg.sender_id.user_id,600, true)
else
Redis:setex(TheDraGo.."polrsho" .. msg.sender_id.user_id,300, true)
...
if Redis:ttl(TheDraGo.."polic" .. msg.sender_id.user_id) >=60 then
local hours = Redis:ttl(TheDraGo.."polic" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id,"⇜ انتا بالسجن 🏤 استنى "..math.floor(hours).." دقائق\n✧","md",true)
end
if Redis:ttl(TheDraGo.."hrame" .. Remsg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheDraGo.."hrame" .. Remsg.sender_id.user_id))
...
shkseto = Redis:get(TheDraGo.."shkse"..Remsg.sender_id.user_id)
if shkseto == "طيبة" then
local hrame = math.floor(math.random() * 200) + 1;
local ballanceed = Redis:get(TheDraGo.."boob"..Remsg.sender_id.user_id) or 0
local ballancope = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
zrfne = ballanceed - hrame
zrfnee = ballancope + hrame
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(zrfnee))
Redis:set(TheDraGo.."boob"..Remsg.sender_id.user_id , math.floor(zrfne))
Redis:setex(TheDraGo.."hrame" .. Remsg.sender_id.user_id,600, true)
local zoropeo = Redis:get(TheDraGo.."rrfff"..msg.sender_id.user_id) or 0
zoroprod = zoropeo + hrame
Redis:set(TheDraGo.."rrfff"..msg.sender_id.user_id,zoroprod)
Redis:sadd(TheDraGo.."rrfffid",msg.sender_id.user_id)
local ban = bot.getUser(Remsg.sender_id.user_id)
if ban.first_name then
news = "["..ban.first_name.."](tg://user?id="..ban.id..")"
else
...
Redis:set(TheDraGo.."msrokid"..msg.chat_id..Remsg.sender_id.user_id,Remsg.sender_id.user_id)
Redis:set(TheDraGo.."hrameid"..msg.chat_id..Remsg.sender_id.user_id,msg.sender_id.user_id)
Redis:set(TheDraGo.."balcmsrok"..msg.chat_id..Remsg.sender_id.user_id,hrame)
Redis:setex(TheDraGo.."timehrame"..msg.chat_id..msg.sender_id.user_id,30, true)
...
local hrameid = Redis:get(TheDraGo.."hrameid"..msg.chat_id..msg.sender_id.user_id)
shkse = Redis:get(TheDraGo.."shkse"..msg.sender_id.user_id)
if shkse == "شريرة" then
return send(msg.chat_id,msg.id, "⇜ شخصيتك شريرة مايمديك تطلب الشرطة","md",true)
end
if Redis:get(TheDraGo.."timehrame"..msg.chat_id.. hrameid) then
local hours = Redis:ttl(TheDraGo.."timehrame" .. hrameid)
local msrokid = Redis:get(TheDraGo.."msrokid"..msg.chat_id..msg.sender_id.user_id)
local hrameid = Redis:get(TheDraGo.."hrameid"..msg.chat_id..msg.sender_id.user_id)
local balcmsrok = Redis:get(TheDraGo.."balcmsrok"..msg.chat_id..msg.sender_id.user_id) or 0
if tonumber(hrameid) == Remsg.sender_id.user_id and tonumber(msrokid) == msg.sender_id.user_id then
local ballancehrame = Redis:get(TheDraGo.."boob"..hrameid) or 0
local ballancmsrok = Redis:get(TheDraGo.."boob"..msrokid) or 0
ballancehramenow = tonumber(ballancehrame) - tonumber(balcmsrok)
ballancmsroknow = tonumber(ballancmsrok) + tonumber(balcmsrok)
Redis:set(TheDraGo.."boob"..hrameid , ballancehramenow)
Redis:set(TheDraGo.."boob"..msrokid , ballancmsroknow)
...
Redis:setex(TheDraGo.."polic" .. hrameid,600, true)
Redis:del(TheDraGo.."msrokid" ..msg.chat_id..msg.sender_id.user_id) 
Redis:del(TheDraGo.."hrameid" ..msg.chat_id..msg.sender_id.user_id) 
Redis:del(TheDraGo.."balcmsrok" ..msg.chat_id..msg.sender_id.user_id) 
Redis:del(TheDraGo.."timehrame" ..msg.chat_id..msg.sender_id.user_id)
...
if Redis:ttl(TheDraGo.."iiioo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheDraGo.."iiioo" .. msg.sender_id.user_id))
...
local ballancee = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
shkse = Redis:get(TheDraGo.."shkse"..msg.sender_id.user_id)
ratbinc = Redis:get(TheDraGo.."ratbinc"..msg.sender_id.user_id) or 1
ratbtrans = Redis:get(TheDraGo.."ratbtrans"..msg.sender_id.user_id) or 1
if shkse == "طيبة" then
if tonumber(ratbinc) >= 270 and tonumber(ratbtrans) == 10 then
local ratpep = ballancee + 500000
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(ratpep))
local ballancee = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballancee)
Redis:setex(TheDraGo.."iiioo" .. msg.sender_id.user_id,600, true)
Redis:incrby(TheDraGo.."ratbinc"..msg.sender_id.user_id,1)
ratbinc = Redis:get(TheDraGo.."ratbinc"..msg.sender_id.user_id)
...
Redis:set(TheDraGo.."ratbinc"..msg.sender_id.user_id,300)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 500000 درهم 💵\n⇜ وظيفتك : ملك 👑\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : `"..convert_mony.."` درهم 💵\n✧","md",true)
end
...
Redis:setex(TheDraGo.."iiioo" .. msg.sender_id.user_id,600, true)
Redis:incrby(TheDraGo.."ratbinc"..msg.sender_id.user_id,1)
ratbinc = Redis:get(TheDraGo.."ratbinc"..msg.sender_id.user_id) or 0
if tonumber(ratbinc) == 270 or tonumber(ratbinc) == 271 then
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 200000 درهم 💵\n⇜ وظيفتك : امير 🤵‍♂️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(TheDraGo.."ratbinc"..msg.sender_id.user_id,270)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 200000 درهم 💵\n⇜ وظيفتك : امير 🤵‍♂️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 100000 درهم 💵\n⇜ وظيفتك : وزير 🤵‍♂️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(TheDraGo.."ratbinc"..msg.sender_id.user_id,240)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 100000 درهم 💵\n⇜ وظيفتك : وزير 🤵‍♂️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
Redis:set(TheDraGo.."ratbinc"..msg.sender_id.user_id,210)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 70000 درهم 💵\n⇜ وظيفتك : بزنس مان كبير 💸\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 40000 درهم 💵\n⇜ وظيفتك : تاجر صغير 💰\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(TheDraGo.."ratbinc"..msg.sender_id.user_id,180)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 40000 درهم 💵\n⇜ وظيفتك : تاجر صغير 💰\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 25000 درهم 💵\n⇜ وظيفتك : طيار 👨‍✈️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(TheDraGo.."ratbinc"..msg.sender_id.user_id,150)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 25000 درهم 💵\n⇜ وظيفتك : طيار 👨‍✈️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 18000 درهم 💵\n⇜ وظيفتك : دكتور 👨‍⚕️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(TheDraGo.."ratbinc"..msg.sender_id.user_id,120)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 18000 درهم 💵\n⇜ وظيفتك : دكتور 👨‍⚕️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 9000 درهم 💵\n⇜ وظيفتك : صيدلي 👨‍🔬\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(TheDraGo.."ratbinc"..msg.sender_id.user_id,90)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 9000 درهم 💵\n⇜ وظيفتك : صيدلي 👨‍🔬\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 2500 درهم 💵\n⇜ وظيفتك : نجار 👨‍🔧\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(TheDraGo.."ratbinc"..msg.sender_id.user_id,60)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 2500 درهم 💵\n⇜ وظيفتك : نجار 👨‍🔧\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
Redis:set(TheDraGo.."ratbinc"..msg.sender_id.user_id,30)
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 500 درهم 💵\n⇜ وظيفتك : قروي 👨‍🌾\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 500 درهم 💵\n⇜ وظيفتك : قروي 👨‍🌾\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
Redis:del(TheDraGo.."ratbtrans"..msg.sender_id.user_id)
Redis:set(TheDraGo.."ratbtrans"..msg.sender_id.user_id,10)
nowbalc = tonumber(ballancee) - 1000000000
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(nowbalc))
...
Redis:del(TheDraGo.."ratbtrans"..msg.sender_id.user_id)
Redis:set(TheDraGo.."ratbtrans"..msg.sender_id.user_id,9)
...
Redis:del(TheDraGo.."ratbtrans"..msg.sender_id.user_id)
Redis:set(TheDraGo.."ratbtrans"..msg.sender_id.user_id,8)
...
Redis:del(TheDraGo.."ratbtrans"..msg.sender_id.user_id)
Redis:set(TheDraGo.."ratbtrans"..msg.sender_id.user_id,7)
...
Redis:del(TheDraGo.."ratbtrans"..msg.sender_id.user_id)
Redis:set(TheDraGo.."ratbtrans"..msg.sender_id.user_id,6)
...
Redis:del(TheDraGo.."ratbtrans"..msg.sender_id.user_id)
Redis:set(TheDraGo.."ratbtrans"..msg.sender_id.user_id,5)
...
Redis:del(TheDraGo.."ratbtrans"..msg.sender_id.user_id)
Redis:set(TheDraGo.."ratbtrans"..msg.sender_id.user_id,4)
...
Redis:del(TheDraGo.."ratbtrans"..msg.sender_id.user_id)
Redis:set(TheDraGo.."ratbtrans"..msg.sender_id.user_id,3)
...
Redis:del(TheDraGo.."ratbtrans"..msg.sender_id.user_id)
Redis:set(TheDraGo.."ratbtrans"..msg.sender_id.user_id,2)
...
if Redis:ttl(TheDraGo.."attack" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheDraGo.."attack" .. msg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⇜ خسرت بأخر معركة استنى "..time.." ","md",true)
end
if Redis:ttl(TheDraGo.."defen" .. Remsg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheDraGo.."defen" .. Remsg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⇜ الخصم خسر بأخر معركة\n⇜ يمديك تهاجمه بعد "..time.." ","md",true)
end
if Redis:sismember(TheDraGo.."booob",Remsg.sender_id.user_id) then
ballancope = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
ballanceed = Redis:get(TheDraGo.."boob"..Remsg.sender_id.user_id) or 0
...
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(zrfne))
Redis:set(TheDraGo.."boob"..Remsg.sender_id.user_id , math.floor(zrfnee))
Redis:setex(TheDraGo.."attack" .. msg.sender_id.user_id,600, true)
...
local ballanceed = Redis:get(TheDraGo.."boob"..Remsg.sender_id.user_id) or 0
local ballancope = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
begaatt = Redis:get(TheDraGo.."numattack"..msg.sender_id.user_id) or 200
...
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(zrfne))
Redis:set(TheDraGo.."boob"..Remsg.sender_id.user_id , math.floor(zrfnee))
Redis:setex(TheDraGo.."defen" .. Remsg.sender_id.user_id,1800, true)
Redis:set(TheDraGo.."numattack"..msg.sender_id.user_id , math.floor(numattackk))
...
Redis:setex(TheDraGo.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id,60, true)
send(msg.chat_id,msg.id,[[
– اهلين فيك بمعرض دراكو
- يتوفر لدينا حالياً :
...
if text == "سيارات" and Redis:get(TheDraGo.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(TheDraGo.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
send(msg.chat_id,msg.id,[[
...
if text == "طيارات" and Redis:get(TheDraGo.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(TheDraGo.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
send(msg.chat_id,msg.id,[[
...
if text == "عقارات" and Redis:get(TheDraGo.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(TheDraGo.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
send(msg.chat_id,msg.id,[[
...
if text == "مجوهرات" and Redis:get(TheDraGo.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(TheDraGo.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
send(msg.chat_id,msg.id,[[
...
ballance = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
...
local mgrmasname = Redis:get(TheDraGo.."mgrmasname"..msg.sender_id.user_id)
local mgrmasprice = Redis:get(TheDraGo.."mgrmasprice"..msg.sender_id.user_id) or 0
local mgrmasnum = Redis:get(TheDraGo.."mgrmasnum"..msg.sender_id.user_id) or 0
local mgrmasnow = tonumber(mgrmasnum) + tonumber(coniss)
Redis:set(TheDraGo.."mgrmasnum"..msg.sender_id.user_id , mgrmasnow)
masnamed = "ماسه"
Redis:set(TheDraGo.."mgrmasname"..msg.sender_id.user_id , masnamed)
Redis:set(TheDraGo.."mgrmasprice"..msg.sender_id.user_id , 1000000)
totalypalice = tonumber(ballance) - tonumber(masmgr)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
...
local mgrkldname = Redis:get(TheDraGo.."mgrkldname"..msg.sender_id.user_id)
local mgrkldprice = Redis:get(TheDraGo.."mgrkldprice"..msg.sender_id.user_id) or 0
local mgrkldnum = Redis:get(TheDraGo.."mgrkldnum"..msg.sender_id.user_id) or 0
local mgrkldnow = tonumber(mgrkldnum) + tonumber(coniss)
Redis:set(TheDraGo.."mgrkldnum"..msg.sender_id.user_id , mgrkldnow)
kldnamed = "قلاده"
Redis:set(TheDraGo.."mgrkldname"..msg.sender_id.user_id , kldnamed)
Redis:set(TheDraGo.."mgrkldprice"..msg.sender_id.user_id , 500000)
...
local mgrswrname = Redis:get(TheDraGo.."mgrswrname"..msg.sender_id.user_id)
local mgrswrprice = Redis:get(TheDraGo.."mgrswrprice"..msg.sender_id.user_id) or 0
local mgrswrnum = Redis:get(TheDraGo.."mgrswrnum"..msg.sender_id.user_id) or 0
local mgrswrnow = tonumber(mgrswrnum) + tonumber(coniss)
Redis:set(TheDraGo.."mgrswrnum"..msg.sender_id.user_id , mgrswrnow)
swrnamed = "سوار"
Redis:set(TheDraGo.."mgrswrname"..msg.sender_id.user_id , swrnamed)
Redis:set(TheDraGo.."mgrswrprice"..msg.sender_id.user_id , 200000)
...
local mgrktmname = Redis:get(TheDraGo.."mgrktmname"..msg.sender_id.user_id)
local mgrktmprice = Redis:get(TheDraGo.."mgrktmprice"..msg.sender_id.user_id) or 0
local mgrktmnum = Redis:get(TheDraGo.."mgrktmnum"..msg.sender_id.user_id) or 0
local mgrktmnow = tonumber(mgrktmnum) + tonumber(coniss)
Redis:set(TheDraGo.."mgrktmnum"..msg.sender_id.user_id , mgrktmnow)
ktmnamed = "خاتم"
Redis:set(TheDraGo.."mgrktmname"..msg.sender_id.user_id , ktmnamed)
Redis:set(TheDraGo.."mgrktmprice"..msg.sender_id.user_id , 50000)
...
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , totalypalice)
local convert_mony = string.format("%.0f",math.floor(totalypalice))
local mgrmasnum = Redis:get(TheDraGo.."mgrmasnum"..msg.sender_id.user_id) or 0
if tonumber(mgrmasnum) == 0 then
Redis:del(TheDraGo.."mgrmasname"..msg.sender_id.user_id)
...
if Redis:ttl(TheDraGo.."giftmmt" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheDraGo.."giftmmt" .. msg.sender_id.user_id))
...
local mgrmasnow = tonumber(mgrmasnum) - tonumber(coniss)
Redis:set(TheDraGo.."mgrmasnum"..msg.sender_id.user_id , mgrmasnow)
local mgrmasnumm = Redis:get(TheDraGo.."mgrmasnum"..Remsg.sender_id.user_id) or 0
local mgrmasnoww = tonumber(mgrmasnumm) + tonumber(coniss)
Redis:set(TheDraGo.."mgrmasnum"..Remsg.sender_id.user_id , mgrmasnoww)
masnamed = "ماسه"
Redis:set(TheDraGo.."mgrmasname"..Remsg.sender_id.user_id,masnamed)
local mgrmasnum = Redis:get(TheDraGo.."mgrmasnum"..msg.sender_id.user_id) or 0
if tonumber(mgrmasnum) == 0 then
Redis:del(TheDraGo.."mgrmasname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."mgrmasnum"..msg.sender_id.user_id)
end
Redis:setex(TheDraGo.."giftmmt" .. msg.sender_id.user_id,1800, true)
...
local mgrkldnow = tonumber(mgrkldnum) - tonumber(coniss)
Redis:set(TheDraGo.."mgrkldnum"..msg.sender_id.user_id , mgrkldnow)
local mgrkldnumm = Redis:get(TheDraGo.."mgrkldnum"..Remsg.sender_id.user_id) or 0
local mgrkldnoww = tonumber(mgrkldnumm) + tonumber(coniss)
Redis:set(TheDraGo.."mgrkldnum"..Remsg.sender_id.user_id , mgrkldnoww)
kldnamed = "قلاده"
Redis:set(TheDraGo.."mgrkldname"..Remsg.sender_id.user_id,kldnamed)
local mgrkldnum = Redis:get(TheDraGo.."mgrkldnum"..msg.sender_id.user_id) or 0
if tonumber(mgrkldnum) == 0 then
Redis:del(TheDraGo.."mgrkldname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."mgrkldnum"..msg.sender_id.user_id)
...
local mgrswrnow = tonumber(mgrswrnum) - tonumber(coniss)
Redis:set(TheDraGo.."mgrswrnum"..msg.sender_id.user_id , mgrswrnow)
local mgrswrnumm = Redis:get(TheDraGo.."mgrswrnum"..Remsg.sender_id.user_id) or 0
local mgrswrnoww = tonumber(mgrswrnumm) + tonumber(coniss)
Redis:set(TheDraGo.."mgrswrnum"..Remsg.sender_id.user_id , mgrswrnoww)
swrnamed = "سوار"
Redis:set(TheDraGo.."mgrswrname"..Remsg.sender_id.user_id,swrnamed)
local mgrswrnum = Redis:get(TheDraGo.."mgrswrnum"..msg.sender_id.user_id) or 0
if tonumber(mgrswrnum) == 0 then
Redis:del(TheDraGo.."mgrswrname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."mgrswrnum"..msg.sender_id.user_id)
...
local mgrktmnow = tonumber(mgrktmnum) - tonumber(coniss)
Redis:set(TheDraGo.."mgrktmnum"..msg.sender_id.user_id , mgrktmnow)
local mgrktmnumm = Redis:get(TheDraGo.."mgrktmnum"..Remsg.sender_id.user_id) or 0
local mgrktmnoww = tonumber(mgrktmnumm) + tonumber(coniss)
Redis:set(TheDraGo.."mgrktmnum"..Remsg.sender_id.user_id , mgrktmnoww)
ktmnamed = "خاتم"
Redis:set(TheDraGo.."mgrktmname"..Remsg.sender_id.user_id,ktmnamed)
local mgrktmnum = Redis:get(TheDraGo.."mgrktmnum"..msg.sender_id.user_id) or 0
if tonumber(mgrktmnum) == 0 then
Redis:del(TheDraGo.."mgrktmname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."mgrktmnum"..msg.sender_id.user_id)
...
local akrksrname = Redis:get(TheDraGo.."akrksrname"..msg.sender_id.user_id)
local akrksrprice = Redis:get(TheDraGo.."akrksrprice"..msg.sender_id.user_id) or 0
local akrksrnum = Redis:get(TheDraGo.."akrksrnum"..msg.sender_id.user_id) or 0
local akrksrnow = tonumber(akrksrnum) + tonumber(coniss)
Redis:set(TheDraGo.."akrksrnum"..msg.sender_id.user_id , akrksrnow)
ksrnamed = "قصر"
Redis:set(TheDraGo.."akrksrname"..msg.sender_id.user_id , ksrnamed)
Redis:set(TheDraGo.."akrksrprice"..msg.sender_id.user_id , 1000000)
...
local akrfelname = Redis:get(TheDraGo.."akrfelname"..msg.sender_id.user_id)
local akrfelprice = Redis:get(TheDraGo.."akrfelprice"..msg.sender_id.user_id) or 0
local akrfelnum = Redis:get(TheDraGo.."akrfelnum"..msg.sender_id.user_id) or 0
local akrfelnow = tonumber(akrfelnum) + tonumber(coniss)
Redis:set(TheDraGo.."akrfelnum"..msg.sender_id.user_id , akrfelnow)
felnamed = "فيلا"
Redis:set(TheDraGo.."akrfelname"..msg.sender_id.user_id , felnamed)
Redis:set(TheDraGo.."akrfelprice"..msg.sender_id.user_id , 500000)
...
local akrmnzname = Redis:get(TheDraGo.."akrmnzname"..msg.sender_id.user_id)
local akrmnzprice = Redis:get(TheDraGo.."akrmnzprice"..msg.sender_id.user_id) or 0
local akrmnznum = Redis:get(TheDraGo.."akrmnznum"..msg.sender_id.user_id) or 0
local akrmnznow = tonumber(akrmnznum) + tonumber(coniss)
Redis:set(TheDraGo.."akrmnznum"..msg.sender_id.user_id , akrmnznow)
mnznamed = "منزل"
Redis:set(TheDraGo.."akrmnzname"..msg.sender_id.user_id , mnznamed)
Redis:set(TheDraGo.."akrmnzprice"..msg.sender_id.user_id , 200000)
...
local akrksrnow = tonumber(akrksrnum) - tonumber(coniss)
Redis:set(TheDraGo.."akrksrnum"..msg.sender_id.user_id , akrksrnow)
local akrksrnumm = Redis:get(TheDraGo.."akrksrnum"..Remsg.sender_id.user_id) or 0
local akrksrnoww = tonumber(akrksrnumm) + tonumber(coniss)
Redis:set(TheDraGo.."akrksrnum"..Remsg.sender_id.user_id , akrksrnoww)
ksrnamed = "قصر"
Redis:set(TheDraGo.."akrksrname"..Remsg.sender_id.user_id,ksrnamed)
local akrksrnum = Redis:get(TheDraGo.."akrksrnum"..msg.sender_id.user_id) or 0
if tonumber(akrksrnum) == 0 then
Redis:del(TheDraGo.."akrksrname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."akrksrnum"..msg.sender_id.user_id)
...
local akrfelnow = tonumber(akrfelnum) - tonumber(coniss)
Redis:set(TheDraGo.."akrfelnum"..msg.sender_id.user_id , akrfelnow)
local akrfelnumm = Redis:get(TheDraGo.."akrfelnum"..Remsg.sender_id.user_id) or 0
local akrfelnoww = tonumber(akrfelnumm) + tonumber(coniss)
Redis:set(TheDraGo.."akrfelnum"..Remsg.sender_id.user_id , akrfelnoww)
felnamed = "فيلا"
Redis:set(TheDraGo.."akrfelname"..Remsg.sender_id.user_id,felnamed)
local akrfelnum = Redis:get(TheDraGo.."akrfelnum"..msg.sender_id.user_id) or 0
if tonumber(akrfelnum) == 0 then
Redis:del(TheDraGo.."akrfelname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."akrfelnum"..msg.sender_id.user_id)
...
local akrmnznow = tonumber(akrmnznum) - tonumber(coniss)
Redis:set(TheDraGo.."akrmnznum"..msg.sender_id.user_id , akrmnznow)
local akrmnznumm = Redis:get(TheDraGo.."akrmnznum"..Remsg.sender_id.user_id) or 0
local akrmnznoww = tonumber(akrmnznumm) + tonumber(coniss)
Redis:set(TheDraGo.."akrmnznum"..Remsg.sender_id.user_id , akrmnznoww)
mnznamed = "منزل"
Redis:set(TheDraGo.."akrmnzname"..Remsg.sender_id.user_id,mnznamed)
local akrmnznum = Redis:get(TheDraGo.."akrmnznum"..msg.sender_id.user_id) or 0
if tonumber(akrmnznum) == 0 then
Redis:del(TheDraGo.."akrmnzname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."akrmnznum"..msg.sender_id.user_id)
...
local airshbhname = Redis:get(TheDraGo.."airshbhname"..msg.sender_id.user_id)
local airshbhprice = Redis:get(TheDraGo.."airshbhprice"..msg.sender_id.user_id) or 0
local airshbhnum = Redis:get(TheDraGo.."airshbhnum"..msg.sender_id.user_id) or 0
local airshbhnow = tonumber(airshbhnum) + tonumber(coniss)
Redis:set(TheDraGo.."airshbhnum"..msg.sender_id.user_id , airshbhnow)
shbhnamed = "شبح"
Redis:set(TheDraGo.."airshbhname"..msg.sender_id.user_id , shbhnamed)
Redis:set(TheDraGo.."airshbhprice"..msg.sender_id.user_id , 1000000000)
...
local airsfarname = Redis:get(TheDraGo.."airsfarname"..msg.sender_id.user_id)
local airsfarprice = Redis:get(TheDraGo.."airsfarprice"..msg.sender_id.user_id) or 0
local airsfarnum = Redis:get(TheDraGo.."airsfarnum"..msg.sender_id.user_id) or 0
local airsfarnow = tonumber(airsfarnum) + tonumber(coniss)
Redis:set(TheDraGo.."airsfarnum"..msg.sender_id.user_id , airsfarnow)
sfarnamed = "سفر"
Redis:set(TheDraGo.."airsfarname"..msg.sender_id.user_id , sfarnamed)
Redis:set(TheDraGo.."airsfarprice"..msg.sender_id.user_id , 500000000)
...
local airkhasname = Redis:get(TheDraGo.."airkhasname"..msg.sender_id.user_id)
local airkhasprice = Redis:get(TheDraGo.."airkhasprice"..msg.sender_id.user_id) or 0
local airkhasnum = Redis:get(TheDraGo.."airkhasnum"..msg.sender_id.user_id) or 0
local airkhasnow = tonumber(airkhasnum) + tonumber(coniss)
Redis:set(TheDraGo.."airkhasnum"..msg.sender_id.user_id , airkhasnow)
khasnamed = "خاصه"
Redis:set(TheDraGo.."airkhasname"..msg.sender_id.user_id , khasnamed)
Redis:set(TheDraGo.."airkhasprice"..msg.sender_id.user_id , 200000000)
...
local airshbhnow = tonumber(airshbhnum) - tonumber(coniss)
Redis:set(TheDraGo.."airshbhnum"..msg.sender_id.user_id , airshbhnow)
local airshbhnumm = Redis:get(TheDraGo.."airshbhnum"..Remsg.sender_id.user_id) or 0
local airshbhnoww = tonumber(airshbhnumm) + tonumber(coniss)
Redis:set(TheDraGo.."airshbhnum"..Remsg.sender_id.user_id , airshbhnoww)
shbhnamed = "شبح"
Redis:set(TheDraGo.."airshbhname"..Remsg.sender_id.user_id,shbhnamed)
local airshbhnum = Redis:get(TheDraGo.."airshbhnum"..msg.sender_id.user_id) or 0
if tonumber(airshbhnum) == 0 then
Redis:del(TheDraGo.."airshbhname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."airshbhnum"..msg.sender_id.user_id)
...
local airsfarnow = tonumber(airsfarnum) - tonumber(coniss)
Redis:set(TheDraGo.."airsfarnum"..msg.sender_id.user_id , airsfarnow)
local airsfarnumm = Redis:get(TheDraGo.."airsfarnum"..Remsg.sender_id.user_id) or 0
local airsfarnoww = tonumber(airsfarnumm) + tonumber(coniss)
Redis:set(TheDraGo.."airsfarnum"..Remsg.sender_id.user_id , airsfarnoww)
sfarnamed = "سفر"
Redis:set(TheDraGo.."airsfarname"..Remsg.sender_id.user_id,sfarnamed)
local airsfarnum = Redis:get(TheDraGo.."airsfarnum"..msg.sender_id.user_id) or 0
if tonumber(airsfarnum) == 0 then
Redis:del(TheDraGo.."airsfarname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."airsfarnum"..msg.sender_id.user_id)
...
local airkhasnow = tonumber(airkhasnum) - tonumber(coniss)
Redis:set(TheDraGo.."airkhasnum"..msg.sender_id.user_id , airkhasnow)
local airkhasnumm = Redis:get(TheDraGo.."airkhasnum"..Remsg.sender_id.user_id) or 0
local airkhasnoww = tonumber(airkhasnumm) + tonumber(coniss)
Redis:set(TheDraGo.."airkhasnum"..Remsg.sender_id.user_id , airkhasnoww)
khasnamed = "خاصه"
Redis:set(TheDraGo.."airkhasname"..Remsg.sender_id.user_id,khasnamed)
local airkhasnum = Redis:get(TheDraGo.."airkhasnum"..msg.sender_id.user_id) or 0
if tonumber(airkhasnum) == 0 then
Redis:del(TheDraGo.."airkhasname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."airkhasnum"..msg.sender_id.user_id)
...
local carrangname = Redis:get(TheDraGo.."carrangname"..msg.sender_id.user_id)
local carrangprice = Redis:get(TheDraGo.."carrangprice"..msg.sender_id.user_id) or 0
local carrangnum = Redis:get(TheDraGo.."carrangnum"..msg.sender_id.user_id) or 0
local carrangnow = tonumber(carrangnum) + tonumber(coniss)
Redis:set(TheDraGo.."carrangnum"..msg.sender_id.user_id , carrangnow)
rangnamed = "فيلار"
Redis:set(TheDraGo.."carrangname"..msg.sender_id.user_id , rangnamed)
Redis:set(TheDraGo.."carrangprice"..msg.sender_id.user_id , 10000000)
...
local caraccename = Redis:get(TheDraGo.."caraccename"..msg.sender_id.user_id)
local caracceprice = Redis:get(TheDraGo.."caracceprice"..msg.sender_id.user_id) or 0
local caraccenum = Redis:get(TheDraGo.."caraccenum"..msg.sender_id.user_id) or 0
local caraccenow = tonumber(caraccenum) + tonumber(coniss)
Redis:set(TheDraGo.."caraccenum"..msg.sender_id.user_id , caraccenow)
accenamed = "اكسنت"
Redis:set(TheDraGo.."caraccename"..msg.sender_id.user_id , accenamed)
Redis:set(TheDraGo.."caracceprice"..msg.sender_id.user_id , 9000000)
...
local carcamrname = Redis:get(TheDraGo.."carcamrname"..msg.sender_id.user_id)
local carcamrprice = Redis:get(TheDraGo.."carcamrprice"..msg.sender_id.user_id) or 0
local carcamrnum = Redis:get(TheDraGo.."carcamrnum"..msg.sender_id.user_id) or 0
local carcamrnow = tonumber(carcamrnum) + tonumber(coniss)
Redis:set(TheDraGo.."carcamrnum"..msg.sender_id.user_id , carcamrnow)
camrnamed = "كامري"
Redis:set(TheDraGo.."carcamrname"..msg.sender_id.user_id , camrnamed)
Redis:set(TheDraGo.."carcamrprice"..msg.sender_id.user_id , 8000000)
...
local caralntrname = Redis:get(TheDraGo.."caralntrname"..msg.sender_id.user_id)
local caralntrprice = Redis:get(TheDraGo.."caralntrprice"..msg.sender_id.user_id) or 0
local caralntrnum = Redis:get(TheDraGo.."caralntrnum"..msg.sender_id.user_id) or 0
local caralntrnow = tonumber(caralntrnum) + tonumber(coniss)
Redis:set(TheDraGo.."caralntrnum"..msg.sender_id.user_id , caralntrnow)
alntrnamed = "النترا"
Redis:set(TheDraGo.."caralntrname"..msg.sender_id.user_id , alntrnamed)
Redis:set(TheDraGo.."caralntrprice"..msg.sender_id.user_id , 7000000)
...
local carhilxname = Redis:get(TheDraGo.."carhilxname"..msg.sender_id.user_id)
local carhilxprice = Redis:get(TheDraGo.."carhilxprice"..msg.sender_id.user_id) or 0
local carhilxnum = Redis:get(TheDraGo.."carhilxnum"..msg.sender_id.user_id) or 0
local carhilxnow = tonumber(carhilxnum) + tonumber(coniss)
Redis:set(TheDraGo.."carhilxnum"..msg.sender_id.user_id , carhilxnow)
hilxnamed = "هايلكس"
Redis:set(TheDraGo.."carhilxname"..msg.sender_id.user_id , hilxnamed)
Redis:set(TheDraGo.."carhilxprice"..msg.sender_id.user_id , 6000000)
...
local carsonaname = Redis:get(TheDraGo.."carsonaname"..msg.sender_id.user_id)
local carsonaprice = Redis:get(TheDraGo.."carsonaprice"..msg.sender_id.user_id) or 0
local carsonanum = Redis:get(TheDraGo.."carsonanum"..msg.sender_id.user_id) or 0
local carsonanow = tonumber(carsonanum) + tonumber(coniss)
Redis:set(TheDraGo.."carsonanum"..msg.sender_id.user_id , carsonanow)
sonanamed = "سوناتا"
Redis:set(TheDraGo.."carsonaname"..msg.sender_id.user_id , sonanamed)
Redis:set(TheDraGo.."carsonaprice"..msg.sender_id.user_id , 5000000)
...
local carcoroname = Redis:get(TheDraGo.."carcoroname"..msg.sender_id.user_id)
local carcoroprice = Redis:get(TheDraGo.."carcoroprice"..msg.sender_id.user_id) or 0
local carcoronum = Redis:get(TheDraGo.."carcoronum"..msg.sender_id.user_id) or 0
local carcoronow = tonumber(carcoronum) + tonumber(coniss)
Redis:set(TheDraGo.."carcoronum"..msg.sender_id.user_id , carcoronow)
coronamed = "كورولا"
Redis:set(TheDraGo.."carcoroname"..msg.sender_id.user_id , coronamed)
Redis:set(TheDraGo.."carcoroprice"..msg.sender_id.user_id , 4000000)
...
local carrangnow = tonumber(carrangnum) - tonumber(coniss)
Redis:set(TheDraGo.."carrangnum"..msg.sender_id.user_id , carrangnow)
local carrangnumm = Redis:get(TheDraGo.."carrangnum"..Remsg.sender_id.user_id) or 0
local carrangnoww = tonumber(carrangnumm) + tonumber(coniss)
Redis:set(TheDraGo.."carrangnum"..Remsg.sender_id.user_id , carrangnoww)
rangnamed = "فيلار"
Redis:set(TheDraGo.."carrangname"..Remsg.sender_id.user_id,rangnamed)
local carrangnum = Redis:get(TheDraGo.."carrangnum"..msg.sender_id.user_id) or 0
if tonumber(carrangnum) == 0 then
Redis:del(TheDraGo.."carrangname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."carrangnum"..msg.sender_id.user_id)
...
local caraccenow = tonumber(caraccenum) - tonumber(coniss)
Redis:set(TheDraGo.."caraccenum"..msg.sender_id.user_id , caraccenow)
local caraccenumm = Redis:get(TheDraGo.."caraccenum"..Remsg.sender_id.user_id) or 0
local caraccenoww = tonumber(caraccenumm) + tonumber(coniss)
Redis:set(TheDraGo.."caraccenum"..Remsg.sender_id.user_id , caraccenoww)
accenamed = "اكسنت"
Redis:set(TheDraGo.."caraccename"..Remsg.sender_id.user_id,accenamed)
local caraccenum = Redis:get(TheDraGo.."caraccenum"..msg.sender_id.user_id) or 0
if tonumber(caraccenum) == 0 then
Redis:del(TheDraGo.."caraccename"..msg.sender_id.user_id)
Redis:del(TheDraGo.."caraccenum"..msg.sender_id.user_id)
...
local carcamrnow = tonumber(carcamrnum) - tonumber(coniss)
Redis:set(TheDraGo.."carcamrnum"..msg.sender_id.user_id , carcamrnow)
local carcamrnumm = Redis:get(TheDraGo.."carcamrnum"..Remsg.sender_id.user_id) or 0
local carcamrnoww = tonumber(carcamrnumm) + tonumber(coniss)
Redis:set(TheDraGo.."carcamrnum"..Remsg.sender_id.user_id , carcamrnoww)
camrnamed = "كامري"
Redis:set(TheDraGo.."carcamrname"..Remsg.sender_id.user_id,camrnamed)
local carcamrnum = Redis:get(TheDraGo.."carcamrnum"..msg.sender_id.user_id) or 0
if tonumber(carcamrnum) == 0 then
Redis:del(TheDraGo.."carcamrname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."carcamrnum"..msg.sender_id.user_id)
...
local carhilxnow = tonumber(carhilxnum) - tonumber(coniss)
Redis:set(TheDraGo.."carhilxnum"..msg.sender_id.user_id , carhilxnow)
local carhilxnumm = Redis:get(TheDraGo.."carhilxnum"..Remsg.sender_id.user_id) or 0
local carhilxnoww = tonumber(carhilxnumm) + tonumber(coniss)
Redis:set(TheDraGo.."carhilxnum"..Remsg.sender_id.user_id , carhilxnoww)
hilxnamed = "هايلكس"
Redis:set(TheDraGo.."carhilxname"..Remsg.sender_id.user_id,hilxnamed)
local carhilxnum = Redis:get(TheDraGo.."carhilxnum"..msg.sender_id.user_id) or 0
if tonumber(carhilxnum) == 0 then
Redis:del(TheDraGo.."carhilxname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."carhilxnum"..msg.sender_id.user_id)
...
local caralntrnow = tonumber(caralntrnum) - tonumber(coniss)
Redis:set(TheDraGo.."caralntrnum"..msg.sender_id.user_id , caralntrnow)
local caralntrnumm = Redis:get(TheDraGo.."caralntrnum"..Remsg.sender_id.user_id) or 0
local caralntrnoww = tonumber(caralntrnumm) + tonumber(coniss)
Redis:set(TheDraGo.."caralntrnum"..Remsg.sender_id.user_id , caralntrnoww)
alntrnamed = "النترا"
Redis:set(TheDraGo.."caralntrname"..Remsg.sender_id.user_id,alntrnamed)
local caralntrnum = Redis:get(TheDraGo.."caralntrnum"..msg.sender_id.user_id) or 0
if tonumber(caralntrnum) == 0 then
Redis:del(TheDraGo.."caralntrname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."caralntrnum"..msg.sender_id.user_id)
...
local carsonanow = tonumber(carsonanum) - tonumber(coniss)
Redis:set(TheDraGo.."carsonanum"..msg.sender_id.user_id , carsonanow)
local carsonanumm = Redis:get(TheDraGo.."carsonanum"..Remsg.sender_id.user_id) or 0
local carsonanoww = tonumber(carsonanumm) + tonumber(coniss)
Redis:set(TheDraGo.."carsonanum"..Remsg.sender_id.user_id , carsonanoww)
sonanamed = "سوناتا"
Redis:set(TheDraGo.."carsonaname"..Remsg.sender_id.user_id,sonanamed)
local carsonanum = Redis:get(TheDraGo.."carsonanum"..msg.sender_id.user_id) or 0
if tonumber(carsonanum) == 0 then
Redis:del(TheDraGo.."carsonaname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."carsonanum"..msg.sender_id.user_id)
...
local carcoronow = tonumber(carcoronum) - tonumber(coniss)
Redis:set(TheDraGo.."carcoronum"..msg.sender_id.user_id , carcoronow)
local carcoronumm = Redis:get(TheDraGo.."carcoronum"..Remsg.sender_id.user_id) or 0
local carcoronoww = tonumber(carcoronumm) + tonumber(coniss)
Redis:set(TheDraGo.."carcoronum"..Remsg.sender_id.user_id , carcoronoww)
coronamed = "كورولا"
Redis:set(TheDraGo.."carcoroname"..Remsg.sender_id.user_id,coronamed)
local carcoronum = Redis:get(TheDraGo.."carcoronum"..msg.sender_id.user_id) or 0
if tonumber(carcoronum) == 0 then
Redis:del(TheDraGo.."carcoroname"..msg.sender_id.user_id)
Redis:del(TheDraGo.."carcoronum"..msg.sender_id.user_id)
...
if Redis:get(TheDraGo.."zwag_request:"..msg.sender_id.user_id) then 
...
local UserInfo = bot.getUser(Remsg.sender_id.user_id)
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n⇜ دراكو مو للزواج 🤣","md",true)  
return false
end
if Redis:get(TheDraGo.."roog1"..msg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⇜ ابك تراك متزوج !!","md",true)
return false
end
if Redis:get(TheDraGo.."rooga1"..msg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⇜ ابك تراك متزوج !!","md",true)
return false
end
if Redis:get(TheDraGo.."roog1"..Remsg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⇜ ابعد بعيد لاتحوس وتدور حول المتزوجين","md",true)
return false
end
if Redis:get(TheDraGo.."rooga1"..Remsg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⇜ ابعد بعيد لاتحوس وتدور حول المتزوجين","md",true)
return false
end
if Redis:sismember(TheDraGo.."booob",msg.sender_id.user_id) then
...
Redis:setex(TheDraGo.."zwag_request:"..msg.sender_id.user_id,60,true)
Redis:setex(TheDraGo.."zwag_request:"..Remsg.sender_id.user_id,60,true)
...
if msg.ControllerBot then
  ...
  zwag_list = {}
  for k,v in pairs(zwag_users) do
  local mahr = Redis:get(TheDraGo.."rahr1"..v)
  local zwga = Redis:get(TheDraGo.."rooga1"..v)
...
"30)"
  ...
  local zwga_name = bot.getUser(v[3]).first_name or Redis:get(TheDraGo..v[3].."first_name:") or "لا يوجد اسم"
...
kk = kk:gsub("#[%a%d_]+",'')
local doltebank = Redis:get(TheDraGo.."doltebank"..v[2]) or " "
local doltebankz = Redis:get(TheDraGo.."doltebank"..v[3]) or " "
local mony = v[1]
local convert_mony = string.format("%.0f",mony)
local emo = zwag_emoji[k]
znum = znum + 1
...
if Redis:sismember(TheDraGo.."roogg1",msg.sender_id.user_id) or Redis:sismember(TheDraGo.."roogga1",msg.sender_id.user_id) then
local zoog = Redis:get(TheDraGo.."roog1"..msg.sender_id.user_id)
local zooga = Redis:get(TheDraGo.."rooga1"..msg.sender_id.user_id)
local mahr = Redis:get(TheDraGo.."rahr1"..msg.sender_id.user_id)
...
if Redis:sismember(TheDraGo.."roogg1",Remsg.sender_id.user_id) or Redis:sismember(TheDraGo.."roogga1",Remsg.sender_id.user_id) then
if Redis:sismember(TheDraGo.."booob",msg.sender_id.user_id) then
ballancee = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
if tonumber(ballancee) < 100 then
return send(msg.chat_id,msg.id, "⇜ فلوسك ماتكفي \n✧","md",true)
...
local UserInfo = bot.getUser(Remsg.sender_id.user_id)
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n⇜ دراكو مو متزوجه ","md",true)  
return false
end
local zoog = Redis:get(TheDraGo.."roog1"..Remsg.sender_id.user_id)
local zooga = Redis:get(TheDraGo.."rooga1"..Remsg.sender_id.user_id)
local mahr = Redis:get(TheDraGo.."rahr1"..Remsg.sender_id.user_id)
local bandd = bot.getUser(zoog)
if bandd.first_name then
neews = "["..bandd.first_name.."](tg://user?id="..bandd.id..")"
else
...
local convert_mony = string.format("%.0f",mahr)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(otheka))
...
local zoog = Redis:get(TheDraGo.."roog1"..msg.sender_id.user_id)
local zooga = tonumber(Redis:get(TheDraGo.."rooga1"..msg.sender_id.user_id))
...
Redis:del(TheDraGo.."rahr1"..msg.sender_id.user_id)
Redis:del(TheDraGo.."rahrr1"..msg.sender_id.user_id)
Redis:srem(TheDraGo.."roogg1", zooga)
Redis:srem(TheDraGo.."roogga1", zooga)
Redis:del(TheDraGo.."roog1"..zooga)
Redis:del(TheDraGo.."rooga1"..zooga)
Redis:del(TheDraGo.."rahr1"..zooga)
Redis:del(TheDraGo.."rahrr1"..zooga)
...
local mahrr = Redis:get(TheDraGo.."rahrr1"..msg.sender_id.user_id)
local bandd = bot.getUser(zoog)
if bandd.first_name then
neews = "["..bandd.first_name.."](tg://user?id="..bandd.id..")"
else
...
ballancee = Redis:get(TheDraGo.."boob"..zoog) or 0
kalea = ballancee + mahrr
Redis:set(TheDraGo.."boob"..zoog , kalea)
local convert_mony = string.format("%.0f",mahrr)
send(msg.chat_id,msg.id, "⇜ خلعت زوجك "..neews.."\n⇜ ورجعت له المهر ( "..convert_mony.." درهم 💵 )","md",true)
Redis:srem(TheDraGo.."roogg1", zoog)
Redis:srem(TheDraGo.."roogga1", zoog)
Redis:del(TheDraGo.."roog1"..zoog)
Redis:del(TheDraGo.."rooga1"..zoog)
Redis:del(TheDraGo.."rahr1"..zoog)
Redis:del(TheDraGo.."rahrr1"..zoog)
Redis:srem(TheDraGo.."roogg1", msg.sender_id.user_id)
Redis:srem(TheDraGo.."roogga1", msg.sender_id.user_id)
Redis:del(TheDraGo.."roog1"..msg.sender_id.user_id)
Redis:del(TheDraGo.."rooga1"..msg.sender_id.user_id)
...
Redis:del(TheDraGo..'List_rhan'..msg.chat_id)  
Redis:set(TheDraGo.."playerrhan"..msg.chat_id,msg.sender_id.user_id)
Redis:set(TheDraGo.."playercoins"..msg.chat_id..msg.sender_id.user_id,coniss)
Redis:set(TheDraGo.."raeahkam"..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(TheDraGo..'List_rhan'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(TheDraGo.."Start_rhan"..msg.chat_id,3600,true)
Redis:set(TheDraGo.."allrhan"..msg.chat_id..12345 , coniss)
local ballancee = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
rehan = tonumber(ballancee) - tonumber(coniss)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , rehan)
return send(msg.chat_id,msg.id,"⇜ بدينا المراهنة وسجلت اسمك \n⇜ اللي بده يشارك يرسل ( انا والمبلغ ) .","md",true)
end
if text == 'نعم' and Redis:get(TheDraGo.."Witting_Startrhan"..msg.chat_id) then
rarahkam = Redis:get(TheDraGo.."raeahkam"..msg.chat_id)
if tonumber(rarahkam) == msg.sender_id.user_id then
local list = Redis:smembers(TheDraGo..'List_rhan'..msg.chat_id) 
if #list == 1 then 
...
benrahan = Redis:get(TheDraGo.."allrhan"..msg.chat_id..12345) or 0
local ballancee = Redis:get(TheDraGo.."boob"..UserName) or 0
rehane = tonumber(benrahan) / 100 * 25
rehan = tonumber(ballancee) + math.floor(rehane)
Redis:set(TheDraGo.."boob"..UserName , rehan)
local rhan_users = Redis:smembers(TheDraGo.."List_rhan"..msg.chat_id)
for k,v in pairs(rhan_users) do
Redis:del(TheDraGo..'playercoins'..msg.chat_id..v)
end
Redis:del(TheDraGo..'allrhan'..msg.chat_id..12345) 
Redis:del(TheDraGo..'playerrhan'..msg.chat_id) 
Redis:del(TheDraGo..'raeahkam'..msg.chat_id) 
Redis:del(TheDraGo..'List_rhan'..msg.chat_id) 
Redis:del(TheDraGo.."Witting_Startrhan"..msg.chat_id)
Redis:del(TheDraGo.."Start_rhan"..msg.chat_id)
local ballancee = Redis:get(TheDraGo.."boob"..UserName) or 0
...
local bank_users = Redis:smembers(TheDraGo.."ownernade")
if #bank_users == 0 then
...
mony_listd = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(TheDraGo.."nokatnade"..v) or 0
...
tt = tt:gsub("@[%a%d_]+",'')
tt = tt:gsub("#[%a%d_]+",'')
local kk = Redis:get(TheDraGo.."lkbnade"..v[2])
kk = kk:gsub("🇾🇪️",'')
kk = kk:gsub("🇹🇳",'')
kk = kk:gsub("🇸🇾",'')
kk = kk:gsub("🇸🇩",'')
...
if Redis:sismember(TheDraGo.."booob",msg.sender_id.user_id) then
if Redis:get(TheDraGo.."namenade"..msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ لديك نادي مسبقاً ","md",true)
end
if Redis:sismember(TheDraGo.."lkbnadesadd", Cnamed) then
return send(msg.chat_id,msg.id, "⇜ الاسم موجود مسبقاً\n⇜ اختر اسم اخر\n✧","md",true)
end
Redis:set(TheDraGo.."lkbnade"..msg.sender_id.user_id, Cnamed)
...
if Redis:sismember(TheDraGo.."booob",msg.sender_id.user_id) then
if not Redis:get(TheDraGo.."namenade" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ ماعندك نادي اصلاً\n⇜ قم بانشاء النادي الخاص بك عن طريق الامر \n( `انشاء نادي` ) والاسم","md",true)
end
namfra = Redis:get(TheDraGo.."lkbnade"..msg.sender_id.user_id)
Redis:del(TheDraGo.."namenade"..msg.sender_id.user_id)
Redis:del(TheDraGo.."nokatnade"..msg.sender_id.user_id)
Redis:del(TheDraGo.."energynade"..msg.sender_id.user_id)
Redis:del(TheDraGo.."traningnade"..msg.sender_id.user_id)
...
Redis:del(TheDraGo.."priceplayer".."4"..msg.sender_id.user_id)
Redis:del(TheDraGo.."priceplayer".."5"..msg.sender_id.user_id)
Redis:srem(TheDraGo.."lkbnadesadd", namfra)
Redis:srem(TheDraGo.."ownernade",msg.sender_id.user_id)
Redis:del(TheDraGo.."lkbnade"..msg.sender_id.user_id)
...
if Redis:ttl(TheDraGo.."traningnade" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheDraGo.."traningnade" .. msg.sender_id.user_id))
...
namenade = Redis:get(TheDraGo.."namenade"..msg.sender_id.user_id)
energynade = Redis:get(TheDraGo.."energynade"..msg.sender_id.user_id)
lkbnade = Redis:get(TheDraGo.."lkbnade"..msg.sender_id.user_id)
namenade = Redis:get(TheDraGo.."namenade"..msg.sender_id.user_id)
energyplayer1 = Redis:get(TheDraGo.."energyplayer".."1"..msg.sender_id.user_id)
energyplayer2 = Redis:get(TheDraGo.."energyplayer".."2"..msg.sender_id.user_id)
energyplayer3 = Redis:get(TheDraGo.."energyplayer".."3"..msg.sender_id.user_id)
energyplayer4 = Redis:get(TheDraGo.."energyplayer".."4"..msg.sender_id.user_id)
energyplayer5 = Redis:get(TheDraGo.."energyplayer".."5"..msg.sender_id.user_id)
if tonumber(energynade) < 151 then
Redis:incrby(TheDraGo.."energynade"..msg.sender_id.user_id,1)
end
if energyplayer1 then
if tonumber(energyplayer1) < 151 then
Redis:incrby(TheDraGo.."energyplayer".."1"..msg.sender_id.user_id,1)
end
end
if energyplayer2 then
if tonumber(energyplayer2) < 151 then
Redis:incrby(TheDraGo.."energyplayer".."2"..msg.sender_id.user_id,1)
end
end
if energyplayer3 then
if tonumber(energyplayer3) < 151 then
Redis:incrby(TheDraGo.."energyplayer".."3"..msg.sender_id.user_id,1)
end
end
if energyplayer4 then
if tonumber(energyplayer4) < 151 then
Redis:incrby(TheDraGo.."energyplayer".."4"..msg.sender_id.user_id,1)
end
end
if energyplayer5 then
if tonumber(energyplayer5) < 151 then
Redis:incrby(TheDraGo.."energyplayer".."5"..msg.sender_id.user_id,1)
end
end
energynade = Redis:get(TheDraGo.."energynade"..msg.sender_id.user_id)
Redis:setex(TheDraGo.."traningnade" .. msg.sender_id.user_id,1800, true)
...
Redis:setex(TheDraGo.."changlkbnade" .. msg.chat_id .. ":" .. msg.sender_id.user_id,60, true)
...
if Redis:get(TheDraGo.."changlkbnade" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(TheDraGo.."changlkbnade" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
if text == "الغاء" or text == "الغاء الامر" then
return send(msg.chat_id,msg.id, "⇜ تم الغاء امر تغيير لقب النادي","md",true)
end
if Redis:sismember(TheDraGo.."lkbnadesadd", text) then
return send(msg.chat_id,msg.id, "⇜ الاسم موجود مسبقاً\n⇜ اختر اسم اخر\n✧","md",true)
end
namfra = Redis:get(TheDraGo.."lkbnade"..msg.sender_id.user_id)
Redis:srem(TheDraGo.."lkbnadesadd", namfra)
Redis:del(TheDraGo.."lkbnade"..msg.sender_id.user_id)
Redis:set(TheDraGo.."lkbnade"..msg.sender_id.user_id, text)
Redis:sadd(TheDraGo.."lkbnadesadd", text)
ballance = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
cccallcc = tonumber(ballance) - 25000
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id,cccallcc)
ballance = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
...
nameplayer1 = Redis:get(TheDraGo.."nameplayer".."1"..msg.sender_id.user_id)
nameplayer2 = Redis:get(TheDraGo.."nameplayer".."2"..msg.sender_id.user_id)
nameplayer3 = Redis:get(TheDraGo.."nameplayer".."3"..msg.sender_id.user_id)
nameplayer4 = Redis:get(TheDraGo.."nameplayer".."4"..msg.sender_id.user_id)
nameplayer5 = Redis:get(TheDraGo.."nameplayer".."5"..msg.sender_id.user_id)
if nameplayer1 then
mrkzplayer1 = Redis:get(TheDraGo.."mrkzplayer".."1"..msg.sender_id.user_id)
cityplayer1 = Redis:get(TheDraGo.."cityplayer".."1"..msg.sender_id.user_id)
energyplayer1 = Redis:get(TheDraGo.."energyplayer".."1"..msg.sender_id.user_id)
priceplayer1 = Redis:get(TheDraGo.."priceplayer".."1"..msg.sender_id.user_id)
nameplayer1done = "⌯ اسم اللاعب : `"..nameplayer1.."`\n- مركزه : "..mrkzplayer1.."\n- طاقة اللاعب : "..energyplayer1.."\n- الجنسية : "..cityplayer1.."\n- السعر : "..priceplayer1.."\n\n"
else
nameplayer1done = ""
end
if nameplayer2 then
mrkzplayer2 = Redis:get(TheDraGo.."mrkzplayer".."2"..msg.sender_id.user_id)
cityplayer2 = Redis:get(TheDraGo.."cityplayer".."2"..msg.sender_id.user_id)
energyplayer2 = Redis:get(TheDraGo.."energyplayer".."2"..msg.sender_id.user_id)
priceplayer2 = Redis:get(TheDraGo.."priceplayer".."2"..msg.sender_id.user_id)
nameplayer2done = "⌯ اسم اللاعب : `"..nameplayer2.."`\n- مركزه : "..mrkzplayer2.."\n- طاقة اللاعب : "..energyplayer2.."\n- الجنسية : "..cityplayer2.."\n- السعر : "..priceplayer2.."\n\n"
else
nameplayer2done = ""
end
if nameplayer3 then
mrkzplayer3 = Redis:get(TheDraGo.."mrkzplayer".."3"..msg.sender_id.user_id)
cityplayer3 = Redis:get(TheDraGo.."cityplayer".."3"..msg.sender_id.user_id)
energyplayer3 = Redis:get(TheDraGo.."energyplayer".."3"..msg.sender_id.user_id)
priceplayer3 = Redis:get(TheDraGo.."priceplayer".."3"..msg.sender_id.user_id)
nameplayer3done = "⌯ اسم اللاعب : `"..nameplayer3.."`\n- مركزه : "..mrkzplayer3.."\n- طاقة اللاعب : "..energyplayer3.."\n- الجنسية : "..cityplayer3.."\n- السعر : "..priceplayer3.."\n\n"
else
nameplayer3done = ""
end
if nameplayer4 then
mrkzplayer4 = Redis:get(TheDraGo.."mrkzplayer".."4"..msg.sender_id.user_id)
cityplayer4 = Redis:get(TheDraGo.."cityplayer".."4"..msg.sender_id.user_id)
energyplayer4 = Redis:get(TheDraGo.."energyplayer".."4"..msg.sender_id.user_id)
priceplayer4 = Redis:get(TheDraGo.."priceplayer".."4"..msg.sender_id.user_id)
nameplayer4done = "⌯ اسم اللاعب : `"..nameplayer4.."`\n- مركزه : "..mrkzplayer4.."\n- طاقة اللاعب : "..energyplayer4.."\n- الجنسية : "..cityplayer4.."\n- السعر : "..priceplayer4.."\n\n"
else
nameplayer4done = ""
end
if nameplayer5 then
mrkzplayer5 = Redis:get(TheDraGo.."mrkzplayer".."5"..msg.sender_id.user_id)
cityplayer5 = Redis:get(TheDraGo.."cityplayer".."5"..msg.sender_id.user_id)
energyplayer5 = Redis:get(TheDraGo.."energyplayer".."5"..msg.sender_id.user_id)
priceplayer5 = Redis:get(TheDraGo.."priceplayer".."5"..msg.sender_id.user_id)
...
Redis:setex(TheDraGo.."shoplyname" .. msg.chat_id .. ":" .. msg.sender_id.user_id,60, true)
...
if Redis:get(TheDraGo.."shoplyname" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(TheDraGo.."shoplyname" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
if text == "الغاء" or text == "الغاء الامر" then
...
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id,pricetotaly)
Redis:del(TheDraGo.."nameplayer".."1"..msg.sender_id.user_id)
Redis:del(TheDraGo.."energyplayer".."1"..msg.sender_id.user_id)
Redis:del(TheDraGo.."mrkzplayer".."1"..msg.sender_id.user_id)
Redis:del(TheDraGo.."cityplayer".."1"..msg.sender_id.user_id)
...
energynade = Redis:get(TheDraGo.."energynade"..msg.sender_id.user_id)
lkbnade = Redis:get(TheDraGo.."lkbnade"..msg.sender_id.user_id)
nokatnade = Redis:get(TheDraGo.."nokatnade"..msg.sender_id.user_id) or 0
nameplayer1 = Redis:get(TheDraGo.."nameplayer".."1"..msg.sender_id.user_id)
nameplayer2 = Redis:get(TheDraGo.."nameplayer".."2"..msg.sender_id.user_id)
nameplayer3 = Redis:get(TheDraGo.."nameplayer".."3"..msg.sender_id.user_id)
nameplayer4 = Redis:get(TheDraGo.."nameplayer".."4"..msg.sender_id.user_id)
...
local UserInfo = bot.getUser(Remsg.sender_id.user_id)
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n⇜ دراكو ماعندها نادي ","md",true)
return false
end
if not Redis:get(TheDraGo.."namenade" .. Remsg.sender_id.user_id) then
...
namenade = Redis:get(TheDraGo.."namenade"..Remsg.sender_id.user_id)
energynade = Redis:get(TheDraGo.."energynade"..Remsg.sender_id.user_id)
lkbnade = Redis:get(TheDraGo.."lkbnade"..Remsg.sender_id.user_id)
nokatnade = Redis:get(TheDraGo.."nokatnade"..Remsg.sender_id.user_id) or 0
nameplayer1 = Redis:get(TheDraGo.."nameplayer".."1"..Remsg.sender_id.user_id)
nameplayer2 = Redis:get(TheDraGo.."nameplayer".."2"..Remsg.sender_id.user_id)
nameplayer3 = Redis:get(TheDraGo.."nameplayer".."3"..Remsg.sender_id.user_id)
nameplayer4 = Redis:get(TheDraGo.."nameplayer".."4"..Remsg.sender_id.user_id)
nameplayer5 = Redis:get(TheDraGo.."nameplayer".."5"..Remsg.sender_id.user_id)
if nameplayer1 then
mrkzplayer1 = Redis:get(TheDraGo.."mrkzplayer".."1"..Remsg.sender_id.user_id)
cityplayer1 = Redis:get(TheDraGo.."cityplayer".."1"..Remsg.sender_id.user_id)
energyplayer1 = Redis:get(TheDraGo.."energyplayer".."1"..Remsg.sender_id.user_id)
nameplayer1done = "⌯ اسم اللاعب : "..nameplayer1.."\n- مركزه : "..mrkzplayer1.."\n- طاقة اللاعب : "..energyplayer1.."\n- الجنسية : "..cityplayer1.."\n\n"
else
nameplayer1done = ""
end
if nameplayer2 then
mrkzplayer2 = Redis:get(TheDraGo.."mrkzplayer".."2"..Remsg.sender_id.user_id)
cityplayer2 = Redis:get(TheDraGo.."cityplayer".."2"..Remsg.sender_id.user_id)
energyplayer2 = Redis:get(TheDraGo.."energyplayer".."2"..Remsg.sender_id.user_id)
nameplayer2done = "⌯ اسم اللاعب : "..nameplayer2.."\n- مركزه : "..mrkzplayer2.."\n- طاقة اللاعب : "..energyplayer2.."\n- الجنسية : "..cityplayer2.."\n\n"
else
nameplayer2done = ""
end
if nameplayer3 then
mrkzplayer3 = Redis:get(TheDraGo.."mrkzplayer".."3"..Remsg.sender_id.user_id)
cityplayer3 = Redis:get(TheDraGo.."cityplayer".."3"..Remsg.sender_id.user_id)
energyplayer3 = Redis:get(TheDraGo.."energyplayer".."3"..Remsg.sender_id.user_id)
nameplayer3done = "⌯ اسم اللاعب : "..nameplayer3.."\n- مركزه : "..mrkzplayer3.."\n- طاقة اللاعب : "..energyplayer3.."\n- الجنسية : "..cityplayer3.."\n\n"
else
nameplayer3done = ""
end
if nameplayer4 then
mrkzplayer4 = Redis:get(TheDraGo.."mrkzplayer".."4"..Remsg.sender_id.user_id)
cityplayer4 = Redis:get(TheDraGo.."cityplayer".."4"..Remsg.sender_id.user_id)
energyplayer4 = Redis:get(TheDraGo.."energyplayer".."4"..Remsg.sender_id.user_id)
nameplayer4done = "⌯ اسم اللاعب : "..nameplayer4.."\n- مركزه : "..mrkzplayer4.."\n- طاقة اللاعب : "..energyplayer4.."\n- الجنسية : "..cityplayer4.."\n\n"
else
nameplayer4done = ""
end
if nameplayer5 then
mrkzplayer5 = Redis:get(TheDraGo.."mrkzplayer".."5"..Remsg.sender_id.user_id)
cityplayer5 = Redis:get(TheDraGo.."cityplayer".."5"..Remsg.sender_id.user_id)
energyplayer5 = Redis:get(TheDraGo.."energyplayer".."5"..Remsg.sender_id.user_id)
nameplayer5done = "⌯ اسم اللاعب : "..nameplayer5.."\n- مركزه : "..mrkzplayer5.."\n- طاقة اللاعب : "..energyplayer5.."\n- الجنسية : "..cityplayer5.."\n\n"
else
nameplayer5done = ""
end
...
if Redis:ttl(TheDraGo.."matchode" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheDraGo.."matchode" .. msg.sender_id.user_id))
...
namenade = Redis:get(TheDraGo.."namenade"..msg.sender_id.user_id)
energynade = Redis:get(TheDraGo.."energynade"..msg.sender_id.user_id)
energyplayer1 = Redis:get(TheDraGo.."energyplayer".."1"..msg.sender_id.user_id) or 0
energyplayer2 = Redis:get(TheDraGo.."energyplayer".."2"..msg.sender_id.user_id) or 0
energyplayer3 = Redis:get(TheDraGo.."energyplayer".."3"..msg.sender_id.user_id) or 0
energyplayer4 = Redis:get(TheDraGo.."energyplayer".."4"..msg.sender_id.user_id) or 0
energyplayer5 = Redis:get(TheDraGo.."energyplayer".."5"..msg.sender_id.user_id) or 0
...
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id,cccallcc)
Redis:incrby(TheDraGo.."energynade"..msg.sender_id.user_id,1)
Redis:incrby(TheDraGo.."nokatnade"..msg.sender_id.user_id,1)
Redis:setex(TheDraGo.."matchode" .. msg.sender_id.user_id,1200, true)
send(msg.chat_id,msg.id, "⌯ لقد فزت بالمبارة "..news.." ⚽️\n⇜ اسم النادي : "..namenade.."\n⇜ نادي الخصم : "..nadebot.."\n⇜ النتيجة : "..result.."\n⇜ تم زيادة نقطة لطاقة ناديك\n✧","md",true)
elseif energymynade < tonumber(energybot) then
Redis:decrby(TheDraGo.."energynade"..msg.sender_id.user_id,1)
energynade = Redis:get(TheDraGo.."energynade"..msg.sender_id.user_id)
if tonumber(energynade) < 0 then
Redis:set(TheDraGo.."energynade"..msg.sender_id.user_id,0)
end
Redis:decrby(TheDraGo.."nokatnade"..msg.sender_id.user_id,1)
nokatnade = Redis:get(TheDraGo.."nokatnade"..msg.sender_id.user_id)
if tonumber(nokatnade) < 0 then
Redis:set(TheDraGo.."nokatnade"..msg.sender_id.user_id,0)
end
Redis:setex(TheDraGo.."matchode" .. msg.sender_id.user_id,1200, true)
...
if Redis:ttl(TheDraGo.."matchplayer" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheDraGo.."matchplayer" .. msg.sender_id.user_id))
...
namenadevs = Redis:get(TheDraGo.."namenade"..Remsg.sender_id.user_id)
energynadevs = Redis:get(TheDraGo.."energynade"..Remsg.sender_id.user_id)
energyplayer1vs = Redis:get(TheDraGo.."energyplayer".."1"..Remsg.sender_id.user_id) or 0
energyplayer2vs = Redis:get(TheDraGo.."energyplayer".."2"..Remsg.sender_id.user_id) or 0
energyplayer3vs = Redis:get(TheDraGo.."energyplayer".."3"..Remsg.sender_id.user_id) or 0
energyplayer4vs = Redis:get(TheDraGo.."energyplayer".."4"..Remsg.sender_id.user_id) or 0
energyplayer5vs = Redis:get(TheDraGo.."energyplayer".."5"..Remsg.sender_id.user_id) or 0
...
Redis:decrby(TheDraGo.."energynade"..Remsg.sender_id.user_id,1)
energynadevs = Redis:get(TheDraGo.."energynade"..Remsg.sender_id.user_id)
if tonumber(energynadevs) < 0 then
Redis:set(TheDraGo.."energynade"..Remsg.sender_id.user_id,0)
end
if energyplayer1vs then
Redis:decrby(TheDraGo.."energyplayer".."1"..Remsg.sender_id.user_id,1)
end
energyplayer1vs = Redis:get(TheDraGo.."energyplayer".."1"..Remsg.sender_id.user_id)
if tonumber(energyplayer1vs) < 0 then
Redis:set(TheDraGo.."energyplayer".."1"..Remsg.sender_id.user_id,0)
end
if energyplayer2vs then
Redis:decrby(TheDraGo.."energyplayer".."2"..Remsg.sender_id.user_id,1)
end
energyplayer2vs = Redis:get(TheDraGo.."energyplayer".."2"..Remsg.sender_id.user_id)
if tonumber(energyplayer2vs) < 0 then
Redis:set(TheDraGo.."energyplayer".."2"..Remsg.sender_id.user_id,0)
end
if energyplayer3vs then
Redis:decrby(TheDraGo.."energyplayer".."3"..Remsg.sender_id.user_id,1)
end
energyplayer3vs = Redis:get(TheDraGo.."energyplayer".."3"..Remsg.sender_id.user_id)
if tonumber(energyplayer3vs) < 0 then
Redis:set(TheDraGo.."energyplayer".."3"..Remsg.sender_id.user_id,0)
end
if energyplayer4vs then
Redis:decrby(TheDraGo.."energyplayer".."4"..Remsg.sender_id.user_id,1)
end
energyplayer4vs = Redis:get(TheDraGo.."energyplayer".."4"..Remsg.sender_id.user_id)
if tonumber(energyplayer4vs) < 0 then
Redis:set(TheDraGo.."energyplayer".."4"..Remsg.sender_id.user_id,0)
end
if energyplayer5vs then
Redis:decrby(TheDraGo.."energyplayer".."5"..Remsg.sender_id.user_id,1)
end
energyplayer5vs = Redis:get(TheDraGo.."energyplayer".."5"..Remsg.sender_id.user_id)
if tonumber(energyplayer5vs) < 0 then
Redis:set(TheDraGo.."energyplayer".."5"..Remsg.sender_id.user_id,0)
end
Redis:decrby(TheDraGo.."nokatnade"..Remsg.sender_id.user_id,1)
nokatnadevs = Redis:get(TheDraGo.."nokatnade"..Remsg.sender_id.user_id)
if tonumber(nokatnadevs) < 0 then
Redis:set(TheDraGo.."nokatnade"..Remsg.sender_id.user_id,0)
end
Redis:setex(TheDraGo.."matchplayer" .. msg.sender_id.user_id,1200, true)
ballance = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
...
Redis:incrby(TheDraGo.."energynade"..Remsg.sender_id.user_id,1)
Redis:incrby(TheDraGo.."nokatnade"..Remsg.sender_id.user_id,1)
if energyplayer1vs then
Redis:incrby(TheDraGo.."energyplayer".."1"..Remsg.sender_id.user_id,1)
end
if energyplayer2vs then
Redis:incrby(TheDraGo.."energyplayer".."2"..Remsg.sender_id.user_id,1)
end
if energyplayer3vs then
Redis:incrby(TheDraGo.."energyplayer".."3"..Remsg.sender_id.user_id,1)
end
if energyplayer4vs then
Redis:incrby(TheDraGo.."energyplayer".."4"..Remsg.sender_id.user_id,1)
end
if energyplayer5vs then
Redis:incrby(TheDraGo.."energyplayer".."5"..Remsg.sender_id.user_id,1)
end
Redis:decrby(TheDraGo.."energynade"..msg.sender_id.user_id,1)
energynade = Redis:get(TheDraGo.."energynade"..msg.sender_id.user_id)
if tonumber(energynade) < 0 then
...
if energyplayer1 then
Redis:decrby(TheDraGo.."energyplayer".."1"..msg.sender_id.user_id,1)
end
energyplayer1 = Redis:get(TheDraGo.."energyplayer".."1"..msg.sender_id.user_id)
if tonumber(energyplayer1) < 0 then
Redis:set(TheDraGo.."energyplayer".."1"..msg.sender_id.user_id,0)
end
if energyplayer2 then
Redis:decrby(TheDraGo.."energyplayer".."2"..msg.sender_id.user_id,1)
end
energyplayer2 = Redis:get(TheDraGo.."energyplayer".."2"..msg.sender_id.user_id)
if tonumber(energyplayer2) < 0 then
Redis:set(TheDraGo.."energyplayer".."2"..msg.sender_id.user_id,0)
end
if energyplayer3 then
Redis:decrby(TheDraGo.."energyplayer".."3"..msg.sender_id.user_id,1)
end
energyplayer3 = Redis:get(TheDraGo.."energyplayer".."3"..msg.sender_id.user_id)
if tonumber(energyplayer3) < 0 then
Redis:set(TheDraGo.."energyplayer".."3"..msg.sender_id.user_id,0)
end
if energyplayer4 then
Redis:decrby(TheDraGo.."energyplayer".."4"..msg.sender_id.user_id,1)
end
energyplayer4 = Redis:get(TheDraGo.."energyplayer".."4"..msg.sender_id.user_id)
if tonumber(energyplayer4) < 0 then
Redis:set(TheDraGo.."energyplayer".."4"..msg.sender_id.user_id,0)
end
if energyplayer5 then
Redis:decrby(TheDraGo.."energyplayer".."5"..msg.sender_id.user_id,1)
end
energyplayer5 = Redis:get(TheDraGo.."energyplayer".."5"..msg.sender_id.user_id)
if tonumber(energyplayer5) < 0 then
Redis:set(TheDraGo.."energyplayer".."5"..msg.sender_id.user_id,0)
end
Redis:decrby(TheDraGo.."nokatnade"..msg.sender_id.user_id,1)
nokatnade = Redis:get(TheDraGo.."nokatnade"..msg.sender_id.user_id)
if tonumber(nokatnade) < 0 then
...
if Redis:sismember(TheDraGo.."booob",msg.sender_id.user_id) then
if Redis:get(TheDraGo.."mrkzplayer".."1"..msg.sender_id.user_id) and Redis:get(TheDraGo.."mrkzplayer".."2"..msg.sender_id.user_id) and Redis:get(TheDraGo.."mrkzplayer".."3"..msg.sender_id.user_id) and Redis:get(TheDraGo.."mrkzplayer".."4"..msg.sender_id.user_id) and Redis:get(TheDraGo.."mrkzplayer".."5"..msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ النادي الخاص بك مكتمل\n⇜ تستطيع بيع لاعب عن طريق الامر ( بيع لاعب )  ","md",true)
end
if Redis:ttl(TheDraGo.."buyplayer" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheDraGo.."buyplayer" .. msg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⇜ تستطيع شراء لاعب بعد "..time.." ","md",true)
end
Redis:setex(TheDraGo.."buyplayer" .. msg.sender_id.user_id,900, true)
...
if Redis:sismember(TheDraGo.."booob",msg.sender_id.user_id) then
ballanceed = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
namefram = Redis:get(TheDraGo.."namefram"..msg.sender_id.user_id)
if Redis:get(TheDraGo.."sizefram"..msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ لديك مزرعه مسبقاً ","md",true)
end
if Redis:sismember(TheDraGo.."farmarname", Cnamed) then
return send(msg.chat_id,msg.id, "⇜ اسم المزرعه موجود مسبقاً\n⇜ اختر اسم اخر\n✧","md",true)
end
Redis:set(TheDraGo.."namefram"..msg.sender_id.user_id, Cnamed)
...
local bank_users = Redis:smembers(TheDraGo.."ownerfram")
if #bank_users == 0 then
...
mony_listd = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(TheDraGo.."toplvfarm"..v) or 0
table.insert(mony_listd, {tonumber(mony) , v})
end
table.sort(mony_listd, function(a, b) return a[1] > b[1] end)
num = 1
...
tt = tt:gsub("@[%a%d_]+",'')
tt = tt:gsub("#[%a%d_]+",'')
local kk = Redis:get(TheDraGo.."namefram"..v[2])
kk = kk:gsub("🇾🇪️",'')
kk = kk:gsub("🇹🇳",'')
kk = kk:gsub("🇸🇾",'')
kk = kk:gsub("🇸🇩",'')
...
if Redis:sismember(TheDraGo.."booob",msg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⌯ اهلا فيك بمزرعة دراكو :\n\n⇜ المزروعات واسعارها :\n- بطاطا : 75 درهم 💵\n- بندوره : 100 درهم 💵\n- خس : 125 درهم 💵\n- خيار : 150 درهم 💵\n- جزر : 175 درهم 💵\n- فليفله : 200 درهم 💵\n- فريز : 300 درهم 💵\n- ذره : 400 درهم 💵\n- ثوم : 500 درهم 💵\n- فطر : 800 درهم 💵\n- شجره تفاح : 1000 درهم 💵\n- شجره عنب : 1250 درهم 💵\n-شجره زيتون : 1500 درهم 💵\n- شجره موز : 2000 درهم 💵\n- شجره مانجا : 3000 درهم 💵\n\n⇜ مثال طريقة الزراعه : \n- زراعه بطاطا 10\n- زراعه شجر موز 15\n✧","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:sismember(TheDraGo.."booob",msg.sender_id.user_id) then
if not Redis:get(TheDraGo.."sizefram" .. msg.sender_id.user_id) then
...
local namefram = Redis:get(TheDraGo.."namefram"..msg.sender_id.user_id)
local sizefram = Redis:get(TheDraGo.."sizefram"..msg.sender_id.user_id)
local mzroatsize = Redis:get(TheDraGo.."mzroatsize"..msg.sender_id.user_id) or 0
local mazofxbh = tonumber(sizefram) - tonumber(mzroatsize)
local btatahours = Redis:ttl(TheDraGo.."btatatime" .. msg.sender_id.user_id) / 60
local btatatime = Redis:get(TheDraGo.."btatatime" .. msg.sender_id.user_id)
local btataname = Redis:get(TheDraGo.."btataname"..msg.sender_id.user_id)
local btatanum = Redis:get(TheDraGo.."btatanum"..msg.sender_id.user_id) or 0
...
local lemonhours = Redis:ttl(TheDraGo.."lemontime" .. msg.sender_id.user_id) / 60
local lemontime = Redis:get(TheDraGo.."lemontime" .. msg.sender_id.user_id)
local lemonname = Redis:get(TheDraGo.."lemonname"..msg.sender_id.user_id)
local lemonnum = Redis:get(TheDraGo.."lemonnum"..msg.sender_id.user_id) or 0
...
local khesshours = Redis:ttl(TheDraGo.."khesstime" .. msg.sender_id.user_id) / 60
local khesstime = Redis:get(TheDraGo.."khesstime" .. msg.sender_id.user_id)
local khessname = Redis:get(TheDraGo.."khessname"..msg.sender_id.user_id)
local khessnum = Redis:get(TheDraGo.."khessnum"..msg.sender_id.user_id) or 0
...
local khearhours = Redis:ttl(TheDraGo.."kheartime" .. msg.sender_id.user_id) / 60
local kheartime = Redis:get(TheDraGo.."kheartime" .. msg.sender_id.user_id)
local khearname = Redis:get(TheDraGo.."khearname"..msg.sender_id.user_id)
local khearnum = Redis:get(TheDraGo.."khearnum"..msg.sender_id.user_id) or 0
...
local jzarhours = Redis:ttl(TheDraGo.."jzartime" .. msg.sender_id.user_id) / 60
local jzartime = Redis:get(TheDraGo.."jzartime" .. msg.sender_id.user_id)
local jzarname = Redis:get(TheDraGo.."jzarname"..msg.sender_id.user_id)
local jzarnum = Redis:get(TheDraGo.."jzarnum"..msg.sender_id.user_id) or 0
...
local fleflahours = Redis:ttl(TheDraGo.."fleflatime" .. msg.sender_id.user_id) / 60
local fleflatime = Redis:get(TheDraGo.."fleflatime" .. msg.sender_id.user_id)
local fleflaname = Redis:get(TheDraGo.."fleflaname"..msg.sender_id.user_id)
local fleflanum = Redis:get(TheDraGo.."fleflanum"..msg.sender_id.user_id) or 0
...
local freazhours = Redis:ttl(TheDraGo.."freaztime" .. msg.sender_id.user_id) / 60
local freaztime = Redis:get(TheDraGo.."freaztime" .. msg.sender_id.user_id)
local freazname = Redis:get(TheDraGo.."freazname"..msg.sender_id.user_id)
local freaznum = Redis:get(TheDraGo.."freaznum"..msg.sender_id.user_id) or 0
...
local dorahours = Redis:ttl(TheDraGo.."doratime" .. msg.sender_id.user_id) / 60
local doratime = Redis:get(TheDraGo.."doratime" .. msg.sender_id.user_id)
local doraname = Redis:get(TheDraGo.."doraname"..msg.sender_id.user_id)
local doranum = Redis:get(TheDraGo.."doranum"..msg.sender_id.user_id) or 0
...
local tomhours = Redis:ttl(TheDraGo.."tomtime" .. msg.sender_id.user_id) / 60
local tomtime = Redis:get(TheDraGo.."tomtime" .. msg.sender_id.user_id)
local tomname = Redis:get(TheDraGo.."tomname"..msg.sender_id.user_id)
local tomnum = Redis:get(TheDraGo.."tomnum"..msg.sender_id.user_id) or 0
...
local ftrhours = Redis:ttl(TheDraGo.."ftrtime" .. msg.sender_id.user_id) / 60
local ftrtime = Redis:get(TheDraGo.."ftrtime" .. msg.sender_id.user_id)
local ftrname = Redis:get(TheDraGo.."ftrname"..msg.sender_id.user_id)
local ftrnum = Redis:get(TheDraGo.."ftrnum"..msg.sender_id.user_id) or 0
...
local tfahhours = Redis:ttl(TheDraGo.."tfahtime" .. msg.sender_id.user_id) / 60
local tfahtime = Redis:get(TheDraGo.."tfahtime" .. msg.sender_id.user_id)
local tfahname = Redis:get(TheDraGo.."tfahname"..msg.sender_id.user_id)
local tfahnum = Redis:get(TheDraGo.."tfahnum"..msg.sender_id.user_id) or 0
...
local enabhours = Redis:ttl(TheDraGo.."enabtime" .. msg.sender_id.user_id) / 60
local enabtime = Redis:get(TheDraGo.."enabtime" .. msg.sender_id.user_id)
local enabname = Redis:get(TheDraGo.."enabname"..msg.sender_id.user_id)
local enabnum = Redis:get(TheDraGo.."enabnum"..msg.sender_id.user_id) or 0
...
local zetonhours = Redis:ttl(TheDraGo.."zetontime" .. msg.sender_id.user_id) / 60
local zetontime = Redis:get(TheDraGo.."zetontime" .. msg.sender_id.user_id)
local zetonname = Redis:get(TheDraGo.."zetonname"..msg.sender_id.user_id)
local zetonnum = Redis:get(TheDraGo.."zetonnum"..msg.sender_id.user_id) or 0
...
local mozzhours = Redis:ttl(TheDraGo.."mozztime" .. msg.sender_id.user_id) / 60
local mozztime = Redis:get(TheDraGo.."mozztime" .. msg.sender_id.user_id)
local mozzname = Redis:get(TheDraGo.."mozzname"..msg.sender_id.user_id)
local mozznum = Redis:get(TheDraGo.."mozznum"..msg.sender_id.user_id) or 0
...
local mangahours = Redis:ttl(TheDraGo.."mangatime" .. msg.sender_id.user_id) / 60
local mangatime = Redis:get(TheDraGo.."mangatime" .. msg.sender_id.user_id)
local manganame = Redis:get(TheDraGo.."manganame"..msg.sender_id.user_id)
local manganum = Redis:get(TheDraGo.."manganum"..msg.sender_id.user_id) or 0
...
if Redis:get(TheDraGo.."btatatime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheDraGo.."btatatime" .. msg.sender_id.user_id) / 60
...
if Redis:get(TheDraGo.."btatanum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة بطاطا قبل 🥔\n⇜ قم بحصادها اولاً\n- طريقة الحصاد بالامر : `حصد بطاطا`","md",true)
end
kajwha = tonumber(coniss) * 0.7
sizefram = Redis:get(TheDraGo.."sizefram"..msg.sender_id.user_id)
if tonumber(kajwha) > tonumber(sizefram) then
return send(msg.chat_id,msg.id, "⇜ مايمديك تشتري مساحة ارضك ماتكفي","md",true)
end
mzroatsize = Redis:get(TheDraGo.."mzroatsize"..msg.sender_id.user_id) or 0
...
Redis:set(TheDraGo.."btatanum"..msg.sender_id.user_id , coniss)
btataname = "بطاطا"
Redis:set(TheDraGo.."btataname"..msg.sender_id.user_id , btataname)
mzroatsize = Redis:get(TheDraGo.."mzroatsize"..msg.sender_id.user_id) or 0
btatasize = tonumber(coniss) * 0.7
btatasizee = btatasize + mzroatsize
Redis:set(TheDraGo.."mzroatsize"..msg.sender_id.user_id , math.floor(btatasizee))
totalypalice = tonumber(ballance) - tonumber(btata)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheDraGo.."btatatime"..msg.sender_id.user_id,1220, true)
local convert_mony = string.format("%.0f",math.floor(btata))
toplvfarm = Redis:get(TheDraGo.."toplvfarm"..msg.sender_id.user_id) or 0
toplvfarmm = tonumber(toplvfarm) + tonumber(coniss)
Redis:set(TheDraGo.."toplvfarm"..msg.sender_id.user_id , toplvfarmm)
...
if Redis:get(TheDraGo.."lemontime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheDraGo.."lemontime" .. msg.sender_id.user_id) / 60
...
if Redis:get(TheDraGo.."lemonnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة بندوره قبل 🍅\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد بندوره`","md",true)
end
...
Redis:set(TheDraGo.."lemonnum"..msg.sender_id.user_id , coniss)
lemonname = "بندوره"
Redis:set(TheDraGo.."lemonname"..msg.sender_id.user_id , lemonname)
mzroatsize = Redis:get(TheDraGo.."mzroatsize"..msg.sender_id.user_id) or 0
lemonsize = tonumber(coniss) * 1
lemonsizee = lemonsize + mzroatsize
Redis:set(TheDraGo.."mzroatsize"..msg.sender_id.user_id , math.floor(lemonsizee))
totalypalice = tonumber(ballance) - tonumber(lemon)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheDraGo.."lemontime"..msg.sender_id.user_id,1520, true)
...
if Redis:get(TheDraGo.."khesstime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheDraGo.."khesstime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة خس قبل 🥬\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصادها\n- طريقة الحصاد بالامر : `حصد خس`","md",true)
end
if Redis:get(TheDraGo.."khessnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة خس قبل 🥬\n⇜ قم بحصادها اولاً\n- طريقة الحصاد بالامر : `حصد خس`","md",true)
end
...
Redis:set(TheDraGo.."khessnum"..msg.sender_id.user_id , coniss)
khessname = "خس"
Redis:set(TheDraGo.."khessname"..msg.sender_id.user_id , khessname)
mzroatsize = Redis:get(TheDraGo.."mzroatsize"..msg.sender_id.user_id) or 0
khesssize = tonumber(coniss) * 1.2
khesssizee = khesssize + mzroatsize
Redis:set(TheDraGo.."mzroatsize"..msg.sender_id.user_id , math.floor(khesssizee))
totalypalice = tonumber(ballance) - tonumber(khess)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheDraGo.."khesstime"..msg.sender_id.user_id,1800, true)
...
if Redis:get(TheDraGo.."kheartime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheDraGo.."kheartime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة خيار قبل 🥒\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد خيار`","md",true)
end
if Redis:get(TheDraGo.."khearnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة خيار قبل 🥒\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد خيار`","md",true)
end
...
Redis:set(TheDraGo.."khearnum"..msg.sender_id.user_id , coniss)
khearname = "خيار"
Redis:set(TheDraGo.."khearname"..msg.sender_id.user_id , khearname)
mzroatsize = Redis:get(TheDraGo.."mzroatsize"..msg.sender_id.user_id) or 0
khearsize = tonumber(coniss) * 1.5
khearsizee = khearsize + mzroatsize
Redis:set(TheDraGo.."mzroatsize"..msg.sender_id.user_id , math.floor(khearsizee))
totalypalice = tonumber(ballance) - tonumber(khear)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheDraGo.."kheartime"..msg.sender_id.user_id,2120, true)
...
if Redis:get(TheDraGo.."jzartime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheDraGo.."jzartime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة جزر قبل 🥕\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد جزر`","md",true)
end
if Redis:get(TheDraGo.."jzarnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة جزر قبل 🥕\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد جزر`","md",true)
end
...
Redis:set(TheDraGo.."jzarnum"..msg.sender_id.user_id , coniss)
jzarname = "جزر"
Redis:set(TheDraGo.."jzarname"..msg.sender_id.user_id , jzarname)
mzroatsize = Redis:get(TheDraGo.."mzroatsize"..msg.sender_id.user_id) or 0
jzarsize = tonumber(coniss) * 1.7
jzarsizee = jzarsize + mzroatsize
Redis:set(TheDraGo.."mzroatsize"..msg.sender_id.user_id , math.floor(jzarsizee))
totalypalice = tonumber(ballance) - tonumber(jzar)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheDraGo.."jzartime"..msg.sender_id.user_id,2420, true)
...
if Redis:get(TheDraGo.."fleflatime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheDraGo.."fleflatime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة فليفله قبل 🫑\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصادها\n- طريقة الحصاد بالامر : `حصد فليفله`","md",true)
end
if Redis:get(TheDraGo.."fleflanum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة فليفله قبل 🫑\n⇜ قم بحصادها اولاً\n- طريقة الحصاد بالامر : `حصد فليفله`","md",true)
end
...
Redis:set(TheDraGo.."fleflanum"..msg.sender_id.user_id , coniss)
fleflaname = "فليفله"
Redis:set(TheDraGo.."fleflaname"..msg.sender_id.user_id , fleflaname)
mzroatsize = Redis:get(TheDraGo.."mzroatsize"..msg.sender_id.user_id) or 0
fleflasize = tonumber(coniss) * 2
fleflasizee = fleflasize + mzroatsize
Redis:set(TheDraGo.."mzroatsize"..msg.sender_id.user_id , math.floor(fleflasizee))
totalypalice = tonumber(ballance) - tonumber(flefla)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheDraGo.."fleflatime"..msg.sender_id.user_id,2720, true)
...
if Redis:get(TheDraGo.."freaztime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheDraGo.."freaztime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة فريز قبل 🍓\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد فريز`","md",true)
end
if Redis:get(TheDraGo.."freaznum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة فريز قبل 🍓\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد فريز`","md",true)
end
...
Redis:set(TheDraGo.."freaznum"..msg.sender_id.user_id , coniss)
freazname = "فريز"
Redis:set(TheDraGo.."freazname"..msg.sender_id.user_id , freazname)
mzroatsize = Redis:get(TheDraGo.."mzroatsize"..msg.sender_id.user_id) or 0
freazsize = tonumber(coniss) * 3
freazsizee = freazsize + mzroatsize
Redis:set(TheDraGo.."mzroatsize"..msg.sender_id.user_id , math.floor(freazsizee))
totalypalice = tonumber(ballance) - tonumber(freaz)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheDraGo.."freaztime"..msg.sender_id.user_id,3020, true)
...
if Redis:get(TheDraGo.."doratime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheDraGo.."doratime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة ذره قبل 🌽\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد ذره`","md",true)
end
if Redis:get(TheDraGo.."doranum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة ذره قبل 🌽\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد ذره`","md",true)
end
...
Redis:set(TheDraGo.."doranum"..msg.sender_id.user_id , coniss)
doraname = "ذره"
Redis:set(TheDraGo.."doraname"..msg.sender_id.user_id , doraname)
mzroatsize = Redis:get(TheDraGo.."mzroatsize"..msg.sender_id.user_id) or 0
dorasize = tonumber(coniss) * 4
dorasizee = dorasize + mzroatsize
Redis:set(TheDraGo.."mzroatsize"..msg.sender_id.user_id , math.floor(dorasizee))
totalypalice = tonumber(ballance) - tonumber(dora)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheDraGo.."doratime"..msg.sender_id.user_id,3320, true)
...
if Redis:get(TheDraGo.."tomtime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheDraGo.."tomtime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة ثوم قبل 🧄\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد ثوم`","md",true)
end
if Redis:get(TheDraGo.."tomnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة ثوم قبل 🧄\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد ثوم`","md",true)
end
...
Redis:set(TheDraGo.."tomnum"..msg.sender_id.user_id , coniss)
tomname = "ثوم"
Redis:set(TheDraGo.."tomname"..msg.sender_id.user_id , tomname)
mzroatsize = Redis:get(TheDraGo.."mzroatsize"..msg.sender_id.user_id) or 0
tomsize = tonumber(coniss) * 5
tomsizee = tomsize + mzroatsize
Redis:set(TheDraGo.."mzroatsize"..msg.sender_id.user_id , math.floor(tomsizee))
totalypalice = tonumber(ballance) - tonumber(tom)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheDraGo.."tomtime"..msg.sender_id.user_id,3620, true)
...
if Redis:get(TheDraGo.."ftrtime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheDraGo.."ftrtime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة فطر قبل 🍄\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد فطر`","md",true)
end
if Redis:get(TheDraGo.."ftrnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة فطر قبل 🍄\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد فطر`","md",true)
end
...
Redis:set(TheDraGo.."ftrnum"..msg.sender_id.user_id , coniss)
ftrname = "فطر"
Redis:set(TheDraGo.."ftrname"..msg.sender_id.user_id , ftrname)
mzroatsize = Redis:get(TheDraGo.."mzroatsize"..msg.sender_id.user_id) or 0
ftrsize = tonumber(coniss) * 6
ftrsizee = ftrsize + mzroatsize
Redis:set(TheDraGo.."mzroatsize"..msg.sender_id.user_id , math.floor(ftrsizee))
totalypalice = tonumber(ballance) - tonumber(ftr)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheDraGo.."ftrtime"..msg.sender_id.user_id,4220, true)
...
if Redis:get(TheDraGo.."tfahtime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheDraGo.."tfahtime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر تفاح قبل 🍏\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر تفاح`","md",true)
end
if Redis:get(TheDraGo.."tfahnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر تفاح قبل 🍏\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر تفاح`","md",true)
end
...
Redis:set(TheDraGo.."tfahnum"..msg.sender_id.user_id , coniss)
tfahname = "تفاح"
Redis:set(TheDraGo.."tfahname"..msg.sender_id.user_id , tfahname)
mzroatsize = Redis:get(TheDraGo.."mzroatsize"..msg.sender_id.user_id) or 0
tfahsize = tonumber(coniss) * 10
tfahsizee = tfahsize + mzroatsize
Redis:set(TheDraGo.."mzroatsize"..msg.sender_id.user_id , math.floor(tfahsizee))
totalypalice = tonumber(ballance) - tonumber(tfah)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheDraGo.."tfahtime"..msg.sender_id.user_id,5420, true)
...
if Redis:get(TheDraGo.."enabtime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheDraGo.."enabtime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر عنب قبل 🍇\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر عنب`","md",true)
end
if Redis:get(TheDraGo.."enabnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر عنب قبل 🍇\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر عنب`","md",true)
end
...
Redis:set(TheDraGo.."enabnum"..msg.sender_id.user_id , coniss)
enabname = "عنب"
Redis:set(TheDraGo.."enabname"..msg.sender_id.user_id , enabname)
mzroatsize = Redis:get(TheDraGo.."mzroatsize"..msg.sender_id.user_id) or 0
enabsize = tonumber(coniss) * 12.5
enabsizee = enabsize + mzroatsize
Redis:set(TheDraGo.."mzroatsize"..msg.sender_id.user_id , math.floor(enabsizee))
totalypalice = tonumber(ballance) - tonumber(enab)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheDraGo.."enabtime"..msg.sender_id.user_id,6020, true)
...
if Redis:get(TheDraGo.."zetontime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheDraGo.."zetontime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر زيتون قبل 🫒\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر زيتون`","md",true)
end
if Redis:get(TheDraGo.."zetonnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر زيتون قبل 🫒\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر زيتون`","md",true)
end
...
Redis:set(TheDraGo.."zetonnum"..msg.sender_id.user_id , coniss)
zetonname = "زيتون"
Redis:set(TheDraGo.."zetonname"..msg.sender_id.user_id , zetonname)
mzroatsize = Redis:get(TheDraGo.."mzroatsize"..msg.sender_id.user_id) or 0
zetonsize = tonumber(coniss) * 15
zetonsizee = zetonsize + mzroatsize
Redis:set(TheDraGo.."mzroatsize"..msg.sender_id.user_id , math.floor(zetonsizee))
totalypalice = tonumber(ballance) - tonumber(zeton)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheDraGo.."zetontime"..msg.sender_id.user_id,7220, true)
...
if Redis:get(TheDraGo.."mozztime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheDraGo.."mozztime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر موز قبل 🍌\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر موز`","md",true)
end
if Redis:get(TheDraGo.."mozznum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر موز قبل 🍌\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر موز`","md",true)
end
...
Redis:set(TheDraGo.."mozznum"..msg.sender_id.user_id , coniss)
mozzname = "موز"
Redis:set(TheDraGo.."mozzname"..msg.sender_id.user_id , mozzname)
mzroatsize = Redis:get(TheDraGo.."mzroatsize"..msg.sender_id.user_id) or 0
mozzsize = tonumber(coniss) * 20
mozzsizee = mozzsize + mzroatsize
Redis:set(TheDraGo.."mzroatsize"..msg.sender_id.user_id , math.floor(mozzsizee))
totalypalice = tonumber(ballance) - tonumber(mozz)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheDraGo.."mozztime"..msg.sender_id.user_id,8420, true)
...
if Redis:get(TheDraGo.."mangatime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheDraGo.."mangatime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر مانجا قبل 🥭\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر مانجا`","md",true)
end
if Redis:get(TheDraGo.."manganum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر مانجا قبل 🥭\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر مانجا`","md",true)
end
...
Redis:set(TheDraGo.."manganum"..msg.sender_id.user_id , coniss)
manganame = "مانجا"
Redis:set(TheDraGo.."manganame"..msg.sender_id.user_id , manganame)
mzroatsize = Redis:get(TheDraGo.."mzroatsize"..msg.sender_id.user_id) or 0
mangasize = tonumber(coniss) * 30
mangasizee = mangasize + mzroatsize
Redis:set(TheDraGo.."mzroatsize"..msg.sender_id.user_id , math.floor(mangasizee))
totalypalice = tonumber(ballance) - tonumber(manga)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheDraGo.."mangatime"..msg.sender_id.user_id,10220, true)
...
if not Redis:get(TheDraGo.."btatanum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
btatanum = Redis:get(TheDraGo.."btatanum"..msg.sender_id.user_id)
btata = tonumber(btatanum) * 100
btataa = tonumber(ballance) + tonumber(btata)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(btataa))
local convert_mony = string.format("%.0f",math.floor(btata))
...
if not Redis:get(TheDraGo.."lemonnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
lemonnum = Redis:get(TheDraGo.."lemonnum"..msg.sender_id.user_id)
lemon = tonumber(lemonnum) * 150
lemona = tonumber(ballance) + tonumber(lemon)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(lemona))
local convert_mony = string.format("%.0f",math.floor(lemon))
...
if not Redis:get(TheDraGo.."khessnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
khessnum = Redis:get(TheDraGo.."khessnum"..msg.sender_id.user_id)
khess = tonumber(khessnum) * 200
khessa = tonumber(ballance) + tonumber(khess)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(khessa))
local convert_mony = string.format("%.0f",math.floor(khess))
...
if not Redis:get(TheDraGo.."khearnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
khearnum = Redis:get(TheDraGo.."khearnum"..msg.sender_id.user_id)
khear = tonumber(khearnum) * 250
kheara = tonumber(ballance) + tonumber(khear)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(kheara))
local convert_mony = string.format("%.0f",math.floor(khear))
...
if not Redis:get(TheDraGo.."jzarnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
jzarnum = Redis:get(TheDraGo.."jzarnum"..msg.sender_id.user_id)
jzar = tonumber(jzarnum) * 300
jzara = tonumber(ballance) + tonumber(jzar)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(jzara))
local convert_mony = string.format("%.0f",math.floor(jzar))
...
if not Redis:get(TheDraGo.."fleflanum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
fleflanum = Redis:get(TheDraGo.."fleflanum"..msg.sender_id.user_id)
flefla = tonumber(fleflanum) * 350
fleflaa = tonumber(ballance) + tonumber(flefla)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(fleflaa))
local convert_mony = string.format("%.0f",math.floor(flefla))
...
if not Redis:get(TheDraGo.."freaznum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
freaznum = Redis:get(TheDraGo.."freaznum"..msg.sender_id.user_id)
freaz = tonumber(freaznum) * 475
freaza = tonumber(ballance) + tonumber(freaz)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(freaza))
local convert_mony = string.format("%.0f",math.floor(freaz))
...
if not Redis:get(TheDraGo.."doranum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
doranum = Redis:get(TheDraGo.."doranum"..msg.sender_id.user_id)
dora = tonumber(doranum) * 600
doraa = tonumber(ballance) + tonumber(dora)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(doraa))
local convert_mony = string.format("%.0f",math.floor(dora))
...
if not Redis:get(TheDraGo.."tomnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
tomnum = Redis:get(TheDraGo.."tomnum"..msg.sender_id.user_id)
tom = tonumber(tomnum) * 725
toma = tonumber(ballance) + tonumber(tom)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(toma))
local convert_mony = string.format("%.0f",math.floor(tom))
...
if not Redis:get(TheDraGo.."ftrnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
ftrnum = Redis:get(TheDraGo.."ftrnum"..msg.sender_id.user_id)
ftr = tonumber(ftrnum) * 800
ftra = tonumber(ballance) + tonumber(ftr)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(ftra))
local convert_mony = string.format("%.0f",math.floor(ftr))
...
if not Redis:get(TheDraGo.."tfahnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
tfahnum = Redis:get(TheDraGo.."tfahnum"..msg.sender_id.user_id)
tfah = tonumber(tfahnum) * 1200
tfaha = tonumber(ballance) + tonumber(tfah)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(tfaha))
local convert_mony = string.format("%.0f",math.floor(tfah))
...
if not Redis:get(TheDraGo.."enabnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
enabnum = Redis:get(TheDraGo.."enabnum"..msg.sender_id.user_id)
enab = tonumber(enabnum) * 1500
enaba = tonumber(ballance) + tonumber(enab)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(enaba))
local convert_mony = string.format("%.0f",math.floor(enab))
...
if not Redis:get(TheDraGo.."zetonnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
zetonnum = Redis:get(TheDraGo.."zetonnum"..msg.sender_id.user_id)
zeton = tonumber(zetonnum) * 1800
zetona = tonumber(ballance) + tonumber(zeton)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(zetona))
local convert_mony = string.format("%.0f",math.floor(zeton))
...
if not Redis:get(TheDraGo.."mozznum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
mozznum = Redis:get(TheDraGo.."mozznum"..msg.sender_id.user_id)
mozz = tonumber(mozznum) * 2500
mozza = tonumber(ballance) + tonumber(mozz)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(mozza))
local convert_mony = string.format("%.0f",math.floor(mozz))
...
if not Redis:get(TheDraGo.."manganum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
manganum = Redis:get(TheDraGo.."manganum"..msg.sender_id.user_id)
manga = tonumber(manganum) * 3500
mangaa = tonumber(ballance) + tonumber(manga)
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(mangaa))
local convert_mony = string.format("%.0f",math.floor(manga))
...
if Redis:ttl(TheDraGo.."yiioooo" .. msg.sender_id.user_id) >=60 then
local hours = Redis:ttl(TheDraGo.."yiioooo" .. msg.sender_id.user_id) / 60
...
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , knez)
local ballancee = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballancee)
send(msg.chat_id,msg.id,""..neews.." لقد وجدت كنز\n⇜ الكنز : قطعة اثرية 🗳\n⇜ سعره : 40000 درهم 💵\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
Redis:setex(TheDraGo.."yiioooo" .. msg.sender_id.user_id,1800, true)
elseif Descriptioont == "2" then
...
bot.sendAudio(msg.chat_id,msg.id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@src_dra")
sleep(1)
...
local coniss = coin(UserName)
if msg.ControllerBot then
Redis:set(TheDraGo.."bandid"..coniss,coniss)
...
local coniss = coin(UserName)
if msg.ControllerBot then
Redis:del(TheDraGo.."bandid"..coniss)
...
local coniss = coin(UserName)
if msg.ControllerBot then
Redis:set(TheDraGo.."morakba"..coniss,coniss)
local ban = bot.getUser(coniss)
if ban.first_name then
news = "["..ban.first_name.."](tg://user?id="..ban.id..")"
else
...
local coniss = coin(UserName)
if msg.ControllerBot then
Redis:del(TheDraGo.."morakba"..coniss)
local ban = bot.getUser(coniss)
if ban.first_name then
news = "["..ban.first_name.."](tg://user?id="..ban.id..")"
else
...
Redis:set(TheDraGo.."cobonum"..numcobo,numcobo)
Redis:set(TheDraGo.."cobon"..numcobo,coniss)
...
cobnum = Redis:get(TheDraGo.."cobonum"..coniss)
if coniss == tonumber(cobnum) then
cobblc = Redis:get(TheDraGo.."cobon"..coniss)
ballancee = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
cobonplus = ballancee + cobblc
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , cobonplus)
local ballancee = Redis:get(TheDraGo.."boob"..msg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballancee)
Redis:del(TheDraGo.."cobon"..coniss)
Redis:del(TheDraGo.."cobonum"..coniss)
send(msg.chat_id,msg.id, "⌯ وصل كوبون \n\n⇜ المبلغ : "..cobblc.." درهم 💵\n⇜ رقم الكوبون : `"..coniss.."`\n⇜ رصيدك الان : `"..convert_mony.."` درهم 💵\n✧","md",true)
else
...
Redis:set(TheDraGo.."boob"..Remsg.sender_id.user_id , bajiop)
ccccc = Redis:get(TheDraGo.."boobb"..Remsg.sender_id.user_id)
uuuuu = Redis:get(TheDraGo.."bbobb"..Remsg.sender_id.user_id)
ppppp = Redis:get(TheDraGo.."rrfff"..Remsg.sender_id.user_id) or 0
ballanceed = Redis:get(TheDraGo.."boob"..Remsg.sender_id.user_id) or 0
...
Redis:set(TheDraGo.."tdbelballance"..msg.sender_id.user_id , coniss)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local UserInfo = bot.getUser(Remsg.sender_id.user_id)
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n⇜ دراكو ماعنده حساب بالبنك ","md",true)  
return false
end
if Redis:sismember(TheDraGo.."booob",Remsg.sender_id.user_id) then
ballanceed = Redis:get(TheDraGo.."boob"..Remsg.sender_id.user_id) or 0
...
if text == 'تبرع' then
if Redis:ttl(TheDraGo.."tabrotime" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheDraGo.."tabrotime" .. msg.sender_id.user_id))
...
local user_name = bot.getUser(winner_id).first_name or Redis:get(TheDraGo..winner_id.."first_name:") or "لا يوجد اسم"
tt =  "["..user_name.."]("..user_name..")"
...
Redis:set(TheDraGo.."boob"..msg.sender_id.user_id , math.floor(byre))
taeswq = Redis:get(TheDraGo.."tabbroat"..msg.sender_id.user_id) or 0
pokloo = tonumber(taeswq) + tonumber(coniss)
Redis:set(TheDraGo.."tabbroat"..msg.sender_id.user_id , math.floor(pokloo))
ballanceeed = Redis:get(TheDraGo.."boob"..winner_id) or 0
tekash = tonumber(ballanceeed) + tonumber(coniss)
Redis:set(TheDraGo.."boob"..winner_id , tonumber(tekash))
ballanceeed = Redis:get(TheDraGo.."boob"..winner_id) or 0
Redis:sadd(TheDraGo.."taza",msg.sender_id.user_id)
Redis:setex(TheDraGo.."tabrotime" .. msg.sender_id.user_id,600, true)
...
if Redis:sismember(TheDraGo.."booob",msg.sender_id.user_id) then
ballancee = Redis:get(TheDraGo.."tabbroat"..msg.sender_id.user_id) or 0
if tonumber(ballancee) < 1 then
...
ballancee = Redis:get(TheDraGo.."tabbroat"..msg.sender_id.user_id) or 0
local bank_users = Redis:smembers(TheDraGo.."taza")
if #bank_users == 0 then
return send(msg.chat_id,msg.id,"⇜ لا يوجد حسابات في البنك","md",true)
end
...
tabr_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(TheDraGo.."tabbroat"..v)
